# Caixa perdida — partida 33, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   V_5_6    |      0.978140 | ⭐ (Escolhida)  |
|   H_4_5    |      0.020927 |                |
|   V_1_0    |      0.000137 |                |
|   V_3_6    |      0.000125 | (Indisponível) |
|   H_8_1    |      0.000073 |                |
|   H_8_5    |      0.000060 | (Indisponível) |
|   V_7_6    |      0.000054 | (Indisponível) |
...
- `cnn1_partida033_jogada025_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida033_jogada025_vit_cnn.md` — este relatório
- `cnn1_partida033_jogada025_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida033_jogada025_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
