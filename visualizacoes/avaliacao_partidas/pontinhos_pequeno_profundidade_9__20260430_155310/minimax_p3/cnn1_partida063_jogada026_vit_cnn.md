...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.992967 | ⭐ (Escolhida)  |
|   H_2_1    |      0.006662 |                |
|   H_0_1    |      0.000095 | (Indisponível) |
...
- `cnn1_partida063_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida063_jogada026_vit_cnn.md` — este relatório
- `cnn1_partida063_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida063_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
