# Caixa perdida — partida 42, jogada 30
...
|:----------:|:-------------:|:--------------:|
|   V_3_6    |      0.976246 | ⭐ (Escolhida)  |
|   V_3_4    |      0.023287 |                |
|   H_2_3    |      0.000055 | (Indisponível) |
|   V_3_2    |      0.000048 | (Indisponível) |
|   H_0_1    |      0.000031 | (Indisponível) |
|   V_1_0    |      0.000025 | (Indisponível) |
|   V_5_6    |      0.000024 | (Indisponível) |
|   V_3_0    |      0.000023 | (Indisponível) |
|   H_2_1    |      0.000022 | (Indisponível) |
|   H_4_5    |      0.000022 | (Indisponível) |
|   H_2_5    |      0.000022 | (Indisponível) |
|   H_0_3    |      0.000020 | (Indisponível) |
|   H_4_1    |      0.000019 | (Indisponível) |
|   V_1_6    |      0.000017 | (Indisponível) |
|   H_0_5    |      0.000015 | (Indisponível) |
|   V_1_2    |      0.000014 | (Indisponível) |
|   H_6_5    |      0.000014 | (Indisponível) |
|   V_5_0    |      0.000014 | (Indisponível) |
|   H_4_3    |      0.000011 | (Indisponível) |
...
- `cnn2_partida042_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida042_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida042_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida042_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
