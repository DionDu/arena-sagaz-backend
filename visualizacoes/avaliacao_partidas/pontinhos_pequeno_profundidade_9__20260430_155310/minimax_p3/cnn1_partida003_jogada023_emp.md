# Caixa perdida — partida 3, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.992901 | ⭐ (Escolhida)  |
|   V_7_2    |      0.005671 |                |
|   V_7_0    |      0.000412 | (Indisponível) |
|   V_7_6    |      0.000208 |                |
|   V_1_6    |      0.000128 |                |
|   H_0_5    |      0.000066 | (Indisponível) |
|   H_8_5    |      0.000062 | (Indisponível) |
|   H_8_3    |      0.000061 | (Indisponível) |
|   H_6_5    |      0.000057 |                |
|   V_3_6    |      0.000039 | (Indisponível) |
...
- `cnn1_partida003_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida003_jogada023_emp.md` — este relatório
- `cnn1_partida003_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida003_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
