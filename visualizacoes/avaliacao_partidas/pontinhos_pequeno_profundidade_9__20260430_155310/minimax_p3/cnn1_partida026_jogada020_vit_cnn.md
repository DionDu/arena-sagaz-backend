...
|:----------:|:-------------:|:--------------:|
|   H_0_5    |      0.996521 | ⭐ (Escolhida)  |
|   V_1_6    |      0.001481 | (Indisponível) |
|   V_1_4    |      0.001480 |                |
|   V_1_0    |      0.000218 |                |
|   H_0_3    |      0.000053 | (Indisponível) |
|   H_0_1    |      0.000030 | (Indisponível) |
|   H_4_5    |      0.000017 |                |
|   V_5_6    |      0.000017 |                |
|   V_1_2    |      0.000015 | (Indisponível) |
|   H_8_5    |      0.000014 | (Indisponível) |
|   H_8_3    |      0.000014 | (Indisponível) |
...
- `cnn1_partida026_jogada020_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida026_jogada020_vit_cnn.md` — este relatório
- `cnn1_partida026_jogada020_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida026_jogada020_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
