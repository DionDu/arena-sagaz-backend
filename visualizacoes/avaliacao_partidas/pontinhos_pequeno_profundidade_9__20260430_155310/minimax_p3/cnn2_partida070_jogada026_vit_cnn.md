# Caixa perdida — partida 70, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.990259 | ⭐ (Escolhida)  |
|   H_2_1    |      0.008169 |                |
|   H_0_1    |      0.000998 | (Indisponível) |
|   V_5_4    |      0.000071 |                |
|   H_4_5    |      0.000067 |                |
|   V_5_0    |      0.000058 | (Indisponível) |
|   V_3_2    |      0.000044 | (Indisponível) |
|   V_3_4    |      0.000035 |                |
|   H_8_5    |      0.000024 | (Indisponível) |
|   H_4_3    |      0.000023 |                |
|   V_3_6    |      0.000022 | (Indisponível) |
|   H_8_3    |      0.000021 | (Indisponível) |
|   H_4_1    |      0.000020 | (Indisponível) |
...
- `cnn2_partida070_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida070_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida070_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida070_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
