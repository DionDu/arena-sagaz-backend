# Caixa perdida — partida 77, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.998772 | ⭐ (Escolhida)  |
|   H_0_1    |      0.000590 | (Indisponível) |
|   H_2_1    |      0.000547 |                |
|   H_6_5    |      0.000008 |                |
...
- `cnn2_partida077_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida077_jogada024_vit_cnn.md` — este relatório
- `cnn2_partida077_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida077_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
