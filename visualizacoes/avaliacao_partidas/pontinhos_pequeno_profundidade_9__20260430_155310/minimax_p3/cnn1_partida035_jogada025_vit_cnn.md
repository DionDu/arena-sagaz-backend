# Caixa perdida — partida 35, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.985209 | ⭐ (Escolhida)  |
|   H_6_5    |      0.011507 |                |
|   H_8_5    |      0.001265 | (Indisponível) |
|   V_1_0    |      0.000371 |                |
|   H_8_1    |      0.000304 |                |
|   H_4_1    |      0.000282 |                |
|   V_5_6    |      0.000168 | (Indisponível) |
|   H_2_1    |      0.000150 |                |
|   H_6_1    |      0.000080 |                |
|   H_0_1    |      0.000071 | (Indisponível) |
|   V_5_0    |      0.000065 | (Indisponível) |
|   V_7_0    |      0.000063 | (Indisponível) |
|   V_5_4    |      0.000061 | (Indisponível) |
|   H_4_5    |      0.000054 | (Indisponível) |
|   H_8_3    |      0.000051 | (Indisponível) |
|   V_3_6    |      0.000045 | (Indisponível) |
|   V_7_2    |      0.000044 | (Indisponível) |
|   V_3_0    |      0.000040 | (Indisponível) |
|   V_5_2    |      0.000031 | (Indisponível) |
|   V_7_4    |      0.000026 | (Indisponível) |
|   H_6_3    |      0.000024 | (Indisponível) |
...
- `cnn1_partida035_jogada025_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida035_jogada025_vit_cnn.md` — este relatório
- `cnn1_partida035_jogada025_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida035_jogada025_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
