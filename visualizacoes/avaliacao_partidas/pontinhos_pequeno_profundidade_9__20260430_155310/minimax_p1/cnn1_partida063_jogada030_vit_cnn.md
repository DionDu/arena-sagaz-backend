# Caixa perdida — partida 63, jogada 30
...
|:----------:|:-------------:|:--------------:|
|   V_5_0    |      0.986511 | ⭐ (Escolhida)  |
|   H_6_1    |      0.013304 |                |
|   H_8_1    |      0.000068 | (Indisponível) |
|   V_7_0    |      0.000026 | (Indisponível) |
|   V_7_2    |      0.000013 | (Indisponível) |
|   H_8_5    |      0.000009 | (Indisponível) |
|   V_3_0    |      0.000008 | (Indisponível) |
|   V_5_2    |      0.000008 | (Indisponível) |
|   V_7_6    |      0.000006 | (Indisponível) |
|   V_7_4    |      0.000005 | (Indisponível) |
|   H_4_1    |      0.000005 | (Indisponível) |
|   H_0_1    |      0.000005 | (Indisponível) |
|   V_1_0    |      0.000004 | (Indisponível) |
|   V_5_6    |      0.000004 | (Indisponível) |
|   H_6_5    |      0.000004 | (Indisponível) |
|   H_8_3    |      0.000003 | (Indisponível) |
|   V_3_6    |      0.000003 | (Indisponível) |
...
|   V_1_6    |      0.000001 | (Indisponível) |
|   H_4_3    |      0.000001 | (Indisponível) |
|   V_3_2    |      0.000001 | (Indisponível) |
|   H_0_3    |      0.000001 | (Indisponível) |
|   H_2_5    |      0.000001 | (Indisponível) |
|   V_1_2    |      0.000001 | (Indisponível) |
|   V_1_4    |      0.000000 | (Indisponível) |
|   V_3_4    |      0.000000 | (Indisponível) |
...
- `cnn1_partida063_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida063_jogada030_vit_cnn.md` — este relatório
- `cnn1_partida063_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida063_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
