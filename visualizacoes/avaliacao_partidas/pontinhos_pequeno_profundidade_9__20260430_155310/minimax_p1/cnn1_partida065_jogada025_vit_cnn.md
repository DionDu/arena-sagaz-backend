# Caixa perdida — partida 65, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.976297 | ⭐ (Escolhida)  |
|   V_1_4    |      0.019142 |                |
|   H_0_5    |      0.001774 | (Indisponível) |
|   V_1_0    |      0.000854 |                |
|   H_0_1    |      0.000234 | (Indisponível) |
|   H_0_3    |      0.000220 | (Indisponível) |
|   H_4_1    |      0.000218 |                |
|   H_2_1    |      0.000215 |                |
|   H_8_1    |      0.000211 |                |
|   H_6_1    |      0.000167 |                |
|   V_1_2    |      0.000139 | (Indisponível) |
|   V_3_6    |      0.000083 | (Indisponível) |
|   V_5_0    |      0.000080 | (Indisponível) |
|   V_3_0    |      0.000052 | (Indisponível) |
|   V_7_0    |      0.000045 | (Indisponível) |
|   H_8_5    |      0.000031 | (Indisponível) |
|   V_5_2    |      0.000030 | (Indisponível) |
|   H_2_3    |      0.000028 | (Indisponível) |
|   V_3_2    |      0.000024 | (Indisponível) |
|   H_8_3    |      0.000022 | (Indisponível) |
|   V_7_6    |      0.000020 | (Indisponível) |
|   H_2_5    |      0.000018 | (Indisponível) |
|   V_7_2    |      0.000014 | (Indisponível) |
|   V_7_4    |      0.000014 | (Indisponível) |
|   V_5_6    |      0.000013 | (Indisponível) |
|   H_4_5    |      0.000012 | (Indisponível) |
|   H_6_5    |      0.000012 | (Indisponível) |
...
- `cnn1_partida065_jogada025_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida065_jogada025_vit_cnn.md` — este relatório
- `cnn1_partida065_jogada025_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida065_jogada025_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
