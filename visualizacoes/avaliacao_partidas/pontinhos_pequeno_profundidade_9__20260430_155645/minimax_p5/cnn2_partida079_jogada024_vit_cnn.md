# Caixa perdida — partida 79, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.999543 | ⭐ (Escolhida)  |
|   H_4_1    |      0.000433 |                |
|   V_5_0    |      0.000005 | (Indisponível) |
|   V_1_0    |      0.000002 | (Indisponível) |
|   V_7_6    |      0.000002 | (Indisponível) |
|   H_0_1    |      0.000001 | (Indisponível) |
|   H_8_3    |      0.000001 | (Indisponível) |
|   H_4_5    |      0.000001 |                |
|   H_6_5    |      0.000001 |                |
|   H_8_5    |      0.000001 | (Indisponível) |
|   V_5_6    |      0.000001 | (Indisponível) |
...
|   V_7_0    |      0.000000 | (Indisponível) |
|   H_6_3    |      0.000000 |                |
|   H_8_1    |      0.000000 | (Indisponível) |
|   H_4_3    |      0.000000 |                |
|   H_6_1    |      0.000000 | (Indisponível) |
|   V_1_2    |      0.000000 | (Indisponível) |
|   V_7_2    |      0.000000 | (Indisponível) |
|   V_3_4    |      0.000000 |                |
...
- `cnn2_partida079_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida079_jogada024_vit_cnn.md` — este relatório
- `cnn2_partida079_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida079_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
