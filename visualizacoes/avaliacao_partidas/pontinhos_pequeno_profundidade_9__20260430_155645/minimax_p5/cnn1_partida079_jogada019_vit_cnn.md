# Caixa perdida — partida 79, jogada 19
...
|:----------:|:-------------:|:--------------:|
|   V_5_6    |      0.992221 | ⭐ (Escolhida)  |
|   H_6_5    |      0.007455 |                |
|   V_7_6    |      0.000101 | (Indisponível) |
...
- `cnn1_partida079_jogada019_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida079_jogada019_vit_cnn.md` — este relatório
- `cnn1_partida079_jogada019_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida079_jogada019_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
