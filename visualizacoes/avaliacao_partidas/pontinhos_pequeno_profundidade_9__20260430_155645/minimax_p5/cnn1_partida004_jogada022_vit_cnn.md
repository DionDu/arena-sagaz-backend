...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.998054 | ⭐ (Escolhida)  |
|   H_0_5    |      0.000977 | (Indisponível) |
|   V_1_4    |      0.000761 |                |
|   H_8_5    |      0.000041 |                |
...
- `cnn1_partida004_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida004_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida004_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida004_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
