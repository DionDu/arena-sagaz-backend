# Caixa perdida — partida 29, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.975523 | ⭐ (Escolhida)  |
|   H_2_5    |      0.020638 |                |
|   H_0_5    |      0.001626 | (Indisponível) |
|   V_1_0    |      0.000368 |                |
|   V_3_6    |      0.000340 | (Indisponível) |
|   V_7_0    |      0.000305 |                |
|   H_4_1    |      0.000217 |                |
|   H_6_1    |      0.000131 |                |
|   H_0_1    |      0.000130 | (Indisponível) |
|   H_2_1    |      0.000110 |                |
|   V_5_0    |      0.000100 | (Indisponível) |
|   H_8_1    |      0.000069 | (Indisponível) |
|   H_8_5    |      0.000058 | (Indisponível) |
|   V_5_2    |      0.000052 | (Indisponível) |
|   V_3_0    |      0.000044 | (Indisponível) |
|   H_4_5    |      0.000038 | (Indisponível) |
...
- `cnn1_partida029_jogada025_emp.png` — visualização com numeração de arestas
- `cnn1_partida029_jogada025_emp.md` — este relatório
- `cnn1_partida029_jogada025_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida029_jogada025_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
