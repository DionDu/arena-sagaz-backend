# Caixa perdida — partida 69, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   H_0_5    |      0.986693 | ⭐ (Escolhida)  |
|   V_1_4    |      0.009609 |                |
|   V_1_6    |      0.001326 | (Indisponível) |
|   V_1_0    |      0.000903 |                |
|   H_0_3    |      0.000188 | (Indisponível) |
|   H_8_1    |      0.000184 |                |
|   H_0_1    |      0.000176 | (Indisponível) |
|   H_4_1    |      0.000160 |                |
|   H_2_1    |      0.000159 |                |
|   H_6_1    |      0.000114 |                |
|   V_1_2    |      0.000111 | (Indisponível) |
|   V_5_0    |      0.000063 | (Indisponível) |
|   V_3_6    |      0.000050 | (Indisponível) |
|   V_3_0    |      0.000045 | (Indisponível) |
|   V_7_0    |      0.000045 | (Indisponível) |
|   H_8_5    |      0.000020 | (Indisponível) |
|   V_5_2    |      0.000019 | (Indisponível) |
|   V_7_6    |      0.000016 | (Indisponível) |
|   H_8_3    |      0.000016 | (Indisponível) |
|   H_2_3    |      0.000015 | (Indisponível) |
|   V_3_2    |      0.000013 | (Indisponível) |
|   V_7_4    |      0.000012 | (Indisponível) |
|   V_7_2    |      0.000011 | (Indisponível) |
|   V_5_6    |      0.000010 | (Indisponível) |
|   H_6_5    |      0.000008 | (Indisponível) |
|   H_2_5    |      0.000008 | (Indisponível) |
|   H_4_5    |      0.000006 | (Indisponível) |
|   H_6_3    |      0.000006 | (Indisponível) |
...
- `cnn1_partida069_jogada025_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida069_jogada025_vit_cnn.md` — este relatório
- `cnn1_partida069_jogada025_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida069_jogada025_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
