# Caixa perdida — partida 25, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.973643 | ⭐ (Escolhida)  |
|   V_7_2    |      0.023114 |                |
|   V_7_6    |      0.000649 |                |
|   V_1_6    |      0.000445 |                |
|   V_7_0    |      0.000384 | (Indisponível) |
|   H_6_5    |      0.000265 |                |
|   H_2_5    |      0.000244 |                |
|   H_8_5    |      0.000159 | (Indisponível) |
|   H_4_5    |      0.000149 |                |
|   H_8_3    |      0.000149 | (Indisponível) |
|   H_0_5    |      0.000131 | (Indisponível) |
|   V_7_4    |      0.000107 | (Indisponível) |
|   V_3_6    |      0.000106 | (Indisponível) |
|   V_5_6    |      0.000091 | (Indisponível) |
|   H_6_3    |      0.000062 | (Indisponível) |
|   V_5_0    |      0.000045 | (Indisponível) |
|   V_5_4    |      0.000042 | (Indisponível) |
|   H_4_1    |      0.000035 | (Indisponível) |
|   H_6_1    |      0.000028 | (Indisponível) |
|   H_0_1    |      0.000027 | (Indisponível) |
|   V_5_2    |      0.000022 | (Indisponível) |
|   V_1_0    |      0.000022 | (Indisponível) |
|   V_3_4    |      0.000017 | (Indisponível) |
|   V_3_0    |      0.000014 | (Indisponível) |
|   H_0_3    |      0.000012 | (Indisponível) |
|   H_4_3    |      0.000010 | (Indisponível) |
|   V_1_4    |      0.000010 | (Indisponível) |
|   V_1_2    |      0.000006 | (Indisponível) |
|   H_2_3    |      0.000004 | (Indisponível) |
|   H_2_1    |      0.000004 | (Indisponível) |
...
- `cnn1_partida025_jogada025_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida025_jogada025_vit_cnn.md` — este relatório
- `cnn1_partida025_jogada025_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida025_jogada025_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
