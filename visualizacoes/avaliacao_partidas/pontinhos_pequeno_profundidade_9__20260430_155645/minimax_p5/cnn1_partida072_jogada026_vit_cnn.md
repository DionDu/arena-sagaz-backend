# Caixa perdida — partida 72, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.921097 | ⭐ (Escolhida)  |
|   H_6_1    |      0.071100 |                |
|   V_5_4    |      0.000940 |                |
|   H_4_5    |      0.000768 |                |
|   V_5_0    |      0.000754 | (Indisponível) |
|   H_4_3    |      0.000715 |                |
|   V_7_0    |      0.000687 | (Indisponível) |
|   V_3_4    |      0.000561 |                |
|   V_5_2    |      0.000443 | (Indisponível) |
|   H_4_1    |      0.000269 | (Indisponível) |
|   V_5_6    |      0.000246 | (Indisponível) |
|   V_3_2    |      0.000228 | (Indisponível) |
|   V_3_6    |      0.000217 | (Indisponível) |
|   V_3_0    |      0.000214 | (Indisponível) |
|   V_7_6    |      0.000210 | (Indisponível) |
|   V_7_4    |      0.000208 | (Indisponível) |
|   V_7_2    |      0.000201 | (Indisponível) |
|   H_8_5    |      0.000161 | (Indisponível) |
|   H_8_3    |      0.000160 | (Indisponível) |
|   H_6_5    |      0.000156 | (Indisponível) |
|   H_6_3    |      0.000149 | (Indisponível) |
|   H_2_1    |      0.000080 | (Indisponível) |
|   H_2_5    |      0.000066 | (Indisponível) |
|   H_2_3    |      0.000064 | (Indisponível) |
|   H_0_3    |      0.000063 | (Indisponível) |
|   H_0_1    |      0.000061 | (Indisponível) |
|   H_0_5    |      0.000053 | (Indisponível) |
|   V_1_0    |      0.000053 | (Indisponível) |
|   V_1_6    |      0.000038 | (Indisponível) |
|   V_1_2    |      0.000027 | (Indisponível) |
...
- `cnn1_partida072_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida072_jogada026_vit_cnn.md` — este relatório
- `cnn1_partida072_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida072_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
