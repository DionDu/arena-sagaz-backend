# Caixa perdida — partida 85, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   H_0_1    |      0.998463 | ⭐ (Escolhida)  |
|   V_1_0    |      0.000773 | (Indisponível) |
|   H_2_1    |      0.000662 |                |
|   H_6_5    |      0.000009 |                |
|   V_5_0    |      0.000008 | (Indisponível) |
...
- `cnn1_partida085_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida085_jogada024_vit_cnn.md` — este relatório
- `cnn1_partida085_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida085_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
