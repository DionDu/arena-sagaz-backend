# Caixa perdida — partida 20, jogada 20
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.992498 | ⭐ (Escolhida)  |
|   V_1_2    |      0.005849 |                |
|   H_0_1    |      0.001146 | (Indisponível) |
|   V_3_0    |      0.000091 |                |
|   H_8_5    |      0.000051 |                |
|   H_0_3    |      0.000050 | (Indisponível) |
|   H_4_1    |      0.000036 |                |
|   V_7_0    |      0.000027 | (Indisponível) |
...
- `cnn1_partida020_jogada020_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida020_jogada020_vit_cnn.md` — este relatório
- `cnn1_partida020_jogada020_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida020_jogada020_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
