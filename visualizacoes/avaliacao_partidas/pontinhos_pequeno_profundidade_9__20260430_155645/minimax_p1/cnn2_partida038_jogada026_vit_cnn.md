...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.978968 | ⭐ (Escolhida)  |
|   V_7_2    |      0.019226 |                |
|   V_7_0    |      0.000305 | (Indisponível) |
|   H_2_5    |      0.000173 |                |
|   V_1_4    |      0.000114 |                |
|   H_2_3    |      0.000109 |                |
|   H_8_3    |      0.000109 | (Indisponível) |
|   H_0_5    |      0.000108 | (Indisponível) |
|   V_3_4    |      0.000077 |                |
|   V_1_6    |      0.000077 | (Indisponível) |
|   H_6_3    |      0.000066 | (Indisponível) |
|   H_8_5    |      0.000065 | (Indisponível) |
|   V_3_6    |      0.000065 | (Indisponível) |
|   V_7_6    |      0.000064 | (Indisponível) |
|   V_5_6    |      0.000059 | (Indisponível) |
|   H_0_3    |      0.000051 | (Indisponível) |
|   V_7_4    |      0.000050 | (Indisponível) |
|   H_4_3    |      0.000036 | (Indisponível) |
|   H_4_1    |      0.000036 | (Indisponível) |
|   H_4_5    |      0.000035 | (Indisponível) |
|   V_5_4    |      0.000033 | (Indisponível) |
|   H_6_5    |      0.000031 | (Indisponível) |
|   V_5_2    |      0.000025 | (Indisponível) |
|   V_1_2    |      0.000022 | (Indisponível) |
|   H_0_1    |      0.000021 | (Indisponível) |
|   V_5_0    |      0.000019 | (Indisponível) |
...
- `cnn2_partida038_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida038_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida038_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida038_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
