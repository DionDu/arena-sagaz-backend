...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.930641 | ⭐ (Escolhida)  |
|   H_2_1    |      0.062635 |                |
|   H_2_3    |      0.001564 |                |
|   H_0_3    |      0.001224 |                |
|   H_0_1    |      0.000760 | (Indisponível) |
|   V_3_4    |      0.000684 |                |
|   V_1_0    |      0.000610 | (Indisponível) |
|   V_3_6    |      0.000501 |                |
|   V_3_2    |      0.000341 | (Indisponível) |
|   V_1_2    |      0.000249 | (Indisponível) |
|   H_0_5    |      0.000101 | (Indisponível) |
|   H_2_5    |      0.000093 | (Indisponível) |
|   V_1_4    |      0.000083 | (Indisponível) |
|   V_1_6    |      0.000075 | (Indisponível) |
|   V_5_0    |      0.000074 | (Indisponível) |
|   H_4_3    |      0.000057 | (Indisponível) |
|   H_4_1    |      0.000054 | (Indisponível) |
|   V_5_2    |      0.000035 | (Indisponível) |
|   H_4_5    |      0.000031 | (Indisponível) |
|   V_5_6    |      0.000025 | (Indisponível) |
|   H_6_5    |      0.000023 | (Indisponível) |
|   V_7_6    |      0.000023 | (Indisponível) |
|   H_8_5    |      0.000019 | (Indisponível) |
|   H_8_3    |      0.000017 | (Indisponível) |
|   V_7_4    |      0.000016 | (Indisponível) |
|   H_6_1    |      0.000015 | (Indisponível) |
|   H_8_1    |      0.000014 | (Indisponível) |
|   V_7_0    |      0.000011 | (Indisponível) |
|   H_6_3    |      0.000010 | (Indisponível) |
|   V_5_4    |      0.000010 | (Indisponível) |
|   V_7_2    |      0.000005 | (Indisponível) |
...
- `cnn1_partida011_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida011_jogada026_vit_cnn.md` — este relatório
- `cnn1_partida011_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida011_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
