# Caixa perdida — partida 92, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.994428 | ⭐ (Escolhida)  |
|   V_1_4    |      0.005107 |                |
|   V_1_6    |      0.000147 | (Indisponível) |
|   H_0_5    |      0.000116 | (Indisponível) |
|   V_5_6    |      0.000021 |                |
|   H_8_1    |      0.000020 |                |
...
- `cnn1_partida092_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida092_jogada023_emp.md` — este relatório
- `cnn1_partida092_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida092_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
