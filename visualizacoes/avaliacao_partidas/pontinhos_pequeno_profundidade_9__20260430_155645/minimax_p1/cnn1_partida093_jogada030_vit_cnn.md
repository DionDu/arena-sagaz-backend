# Caixa perdida — partida 93, jogada 30
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.950163 | ⭐ (Escolhida)  |
|   V_7_4    |      0.047274 |                |
|   H_8_5    |      0.001947 | (Indisponível) |
|   H_8_3    |      0.000207 | (Indisponível) |
|   H_6_3    |      0.000099 | (Indisponível) |
|   V_7_2    |      0.000053 | (Indisponível) |
|   V_5_6    |      0.000043 | (Indisponível) |
|   H_6_5    |      0.000041 | (Indisponível) |
|   V_5_4    |      0.000028 | (Indisponível) |
|   H_8_1    |      0.000020 | (Indisponível) |
|   H_4_1    |      0.000016 | (Indisponível) |
|   V_5_2    |      0.000014 | (Indisponível) |
|   V_7_0    |      0.000014 | (Indisponível) |
|   V_3_6    |      0.000013 | (Indisponível) |
|   H_4_5    |      0.000011 | (Indisponível) |
...
- `cnn1_partida093_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida093_jogada030_vit_cnn.md` — este relatório
- `cnn1_partida093_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida093_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
