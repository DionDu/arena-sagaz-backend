# Caixa perdida — partida 63, jogada 27
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.580677 | ⭐ (Escolhida)  |
|   V_1_4    |      0.402275 |                |
|   H_6_1    |      0.002969 |                |
|   V_5_0    |      0.002870 |                |
|   H_0_5    |      0.002118 | (Indisponível) |
|   H_8_1    |      0.002111 |                |
|   H_0_3    |      0.001205 | (Indisponível) |
|   V_1_2    |      0.000479 | (Indisponível) |
|   H_0_1    |      0.000452 | (Indisponível) |
|   V_7_0    |      0.000445 | (Indisponível) |
|   H_4_1    |      0.000435 | (Indisponível) |
|   H_2_5    |      0.000419 | (Indisponível) |
|   V_3_6    |      0.000417 | (Indisponível) |
|   V_5_2    |      0.000359 | (Indisponível) |
|   H_2_1    |      0.000314 | (Indisponível) |
|   V_3_0    |      0.000313 | (Indisponível) |
|   V_1_0    |      0.000254 | (Indisponível) |
|   H_8_5    |      0.000224 | (Indisponível) |
|   V_7_2    |      0.000187 | (Indisponível) |
|   H_2_3    |      0.000179 | (Indisponível) |
|   V_3_2    |      0.000174 | (Indisponível) |
|   V_7_4    |      0.000155 | (Indisponível) |
|   H_8_3    |      0.000154 | (Indisponível) |
|   V_7_6    |      0.000151 | (Indisponível) |
|   H_6_5    |      0.000140 | (Indisponível) |
|   V_5_6    |      0.000119 | (Indisponível) |
|   H_4_5    |      0.000108 | (Indisponível) |
|   H_6_3    |      0.000101 | (Indisponível) |
|   V_5_4    |      0.000082 | (Indisponível) |
|   V_3_4    |      0.000063 | (Indisponível) |
...
- `cnn1_partida063_jogada027_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida063_jogada027_vit_cnn.md` — este relatório
- `cnn1_partida063_jogada027_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida063_jogada027_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
