# Caixa perdida — partida 61, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.989795 | ⭐ (Escolhida)  |
|   V_1_2    |      0.008145 |                |
|   H_0_1    |      0.000869 | (Indisponível) |
|   V_1_6    |      0.000329 |                |
|   V_7_0    |      0.000234 |                |
|   V_7_2    |      0.000102 |                |
|   H_2_5    |      0.000053 |                |
...
|   H_0_3    |      0.000033 | (Indisponível) |
|   H_8_3    |      0.000033 | (Indisponível) |
|   V_7_6    |      0.000029 | (Indisponível) |
|   H_6_5    |      0.000027 |                |
|   V_5_6    |      0.000026 | (Indisponível) |
|   V_3_0    |      0.000025 | (Indisponível) |
|   H_0_5    |      0.000025 | (Indisponível) |
...
- `cnn1_partida061_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida061_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida061_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida061_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
