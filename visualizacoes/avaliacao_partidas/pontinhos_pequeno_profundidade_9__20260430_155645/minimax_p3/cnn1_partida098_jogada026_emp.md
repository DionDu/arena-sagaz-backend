# Caixa perdida — partida 98, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.945123 | ⭐ (Escolhida)  |
|   H_6_5    |      0.046370 |                |
|   H_8_5    |      0.001587 | (Indisponível) |
|   V_1_0    |      0.001495 |                |
|   V_5_0    |      0.001047 |                |
|   H_4_1    |      0.001008 |                |
|   H_2_1    |      0.000812 |                |
|   V_5_6    |      0.000603 | (Indisponível) |
|   H_0_1    |      0.000255 | (Indisponível) |
|   V_5_4    |      0.000194 | (Indisponível) |
|   V_3_0    |      0.000189 | (Indisponível) |
|   H_4_5    |      0.000171 | (Indisponível) |
|   V_3_6    |      0.000155 | (Indisponível) |
|   H_8_3    |      0.000154 | (Indisponível) |
|   V_5_2    |      0.000125 | (Indisponível) |
|   V_7_4    |      0.000112 | (Indisponível) |
|   H_6_3    |      0.000077 | (Indisponível) |
|   V_1_2    |      0.000059 | (Indisponível) |
|   H_8_1    |      0.000055 | (Indisponível) |
|   H_2_5    |      0.000054 | (Indisponível) |
|   V_3_2    |      0.000050 | (Indisponível) |
|   V_7_0    |      0.000046 | (Indisponível) |
|   V_7_2    |      0.000044 | (Indisponível) |
|   H_0_5    |      0.000041 | (Indisponível) |
|   H_4_3    |      0.000035 | (Indisponível) |
|   V_1_6    |      0.000034 | (Indisponível) |
|   H_6_1    |      0.000034 | (Indisponível) |
|   H_0_3    |      0.000030 | (Indisponível) |
...
- `cnn1_partida098_jogada026_emp.png` — visualização com numeração de arestas
- `cnn1_partida098_jogada026_emp.md` — este relatório
- `cnn1_partida098_jogada026_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida098_jogada026_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
