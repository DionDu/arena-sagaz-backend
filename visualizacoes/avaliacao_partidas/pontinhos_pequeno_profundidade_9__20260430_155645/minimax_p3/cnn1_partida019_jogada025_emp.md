# Caixa perdida — partida 19, jogada 25
...
- `cnn1_partida019_jogada025_emp.png` — visualização com numeração de arestas
- `cnn1_partida019_jogada025_emp.md` — este relatório
- `cnn1_partida019_jogada025_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida019_jogada025_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
