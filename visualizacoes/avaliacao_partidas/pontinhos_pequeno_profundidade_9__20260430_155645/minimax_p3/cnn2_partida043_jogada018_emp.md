# Caixa perdida — partida 43, jogada 18
...
|:----------:|:-------------:|:--------------:|
|   V_5_6    |      0.624330 | ⭐ (Escolhida)  |
|   H_4_5    |      0.356981 |                |
|   V_7_6    |      0.005332 |                |
|   V_1_6    |      0.001493 |                |
|   V_3_6    |      0.001355 | (Indisponível) |
|   V_7_4    |      0.001246 |                |
|   H_8_5    |      0.001151 | (Indisponível) |
|   V_1_0    |      0.000751 |                |
|   H_0_5    |      0.000655 | (Indisponível) |
|   H_2_5    |      0.000635 | (Indisponível) |
|   V_5_4    |      0.000629 | (Indisponível) |
|   H_6_5    |      0.000484 | (Indisponível) |
|   H_8_1    |      0.000465 |                |
|   H_0_1    |      0.000429 | (Indisponível) |
|   V_1_4    |      0.000403 |                |
|   V_7_0    |      0.000362 | (Indisponível) |
|   H_4_1    |      0.000330 |                |
|   V_5_0    |      0.000324 | (Indisponível) |
|   H_2_1    |      0.000250 |                |
|   V_3_2    |      0.000235 | (Indisponível) |
|   H_6_3    |      0.000235 |                |
|   H_4_3    |      0.000228 |                |
|   H_8_3    |      0.000225 | (Indisponível) |
|   H_0_3    |      0.000221 | (Indisponível) |
|   H_6_1    |      0.000202 |                |
|   H_2_3    |      0.000201 |                |
|   V_3_4    |      0.000194 | (Indisponível) |
|   V_7_2    |      0.000188 | (Indisponível) |
|   V_1_2    |      0.000163 | (Indisponível) |
|   V_5_2    |      0.000161 | (Indisponível) |
|   V_3_0    |      0.000140 | (Indisponível) |
...
- `cnn2_partida043_jogada018_emp.png` — visualização com numeração de arestas
- `cnn2_partida043_jogada018_emp.md` — este relatório
- `cnn2_partida043_jogada018_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida043_jogada018_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
