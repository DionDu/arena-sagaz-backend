# Caixa perdida — partida 38, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.858379 | ⭐ (Escolhida)  |
|   V_1_4    |      0.133973 |                |
|   V_1_0    |      0.001890 |                |
|   H_2_1    |      0.001458 |                |
|   H_4_1    |      0.000712 |                |
|   H_0_5    |      0.000690 | (Indisponível) |
|   V_1_6    |      0.000647 | (Indisponível) |
|   V_5_0    |      0.000552 |                |
|   H_0_1    |      0.000492 | (Indisponível) |
|   V_1_2    |      0.000197 | (Indisponível) |
|   V_3_0    |      0.000184 | (Indisponível) |
|   V_3_6    |      0.000159 | (Indisponível) |
|   H_2_5    |      0.000144 | (Indisponível) |
|   V_7_6    |      0.000055 | (Indisponível) |
|   H_6_1    |      0.000049 | (Indisponível) |
|   V_5_2    |      0.000048 | (Indisponível) |
|   V_3_2    |      0.000045 | (Indisponível) |
|   H_8_5    |      0.000039 | (Indisponível) |
|   V_5_6    |      0.000036 | (Indisponível) |
|   V_7_4    |      0.000034 | (Indisponível) |
|   H_8_3    |      0.000031 | (Indisponível) |
|   H_6_5    |      0.000029 | (Indisponível) |
|   H_2_3    |      0.000028 | (Indisponível) |
|   H_8_1    |      0.000024 | (Indisponível) |
|   V_7_0    |      0.000022 | (Indisponível) |
|   H_4_5    |      0.000020 | (Indisponível) |
|   V_3_4    |      0.000015 | (Indisponível) |
|   V_5_4    |      0.000015 | (Indisponível) |
|   H_6_3    |      0.000012 | (Indisponível) |
|   V_7_2    |      0.000011 | (Indisponível) |
...
- `cnn1_partida038_jogada026_emp.png` — visualização com numeração de arestas
- `cnn1_partida038_jogada026_emp.md` — este relatório
- `cnn1_partida038_jogada026_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida038_jogada026_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
