# Caixa perdida — partida 95, jogada 21
...
|:----------:|:-------------:|:--------------:|
|   H_8_3    |      0.866135 | ⭐ (Escolhida)  |
|   V_7_4    |      0.129563 |                |
|   V_5_4    |      0.000459 |                |
|   H_8_5    |      0.000330 | (Indisponível) |
|   H_4_3    |      0.000305 |                |
|   V_1_0    |      0.000298 |                |
|   V_7_6    |      0.000280 | (Indisponível) |
|   H_8_1    |      0.000256 |                |
|   H_6_3    |      0.000245 | (Indisponível) |
|   H_4_5    |      0.000230 |                |
|   H_6_5    |      0.000227 | (Indisponível) |
|   V_5_6    |      0.000202 | (Indisponível) |
|   H_0_1    |      0.000186 | (Indisponível) |
|   V_7_0    |      0.000160 | (Indisponível) |
|   H_4_1    |      0.000133 |                |
|   V_3_6    |      0.000128 | (Indisponível) |
|   V_3_4    |      0.000116 |                |
|   V_5_2    |      0.000115 | (Indisponível) |
|   H_6_1    |      0.000113 |                |
|   V_7_2    |      0.000071 | (Indisponível) |
|   V_5_0    |      0.000065 | (Indisponível) |
|   H_2_1    |      0.000057 |                |
|   H_0_5    |      0.000057 | (Indisponível) |
|   V_3_2    |      0.000047 | (Indisponível) |
|   V_1_6    |      0.000045 | (Indisponível) |
|   V_3_0    |      0.000042 | (Indisponível) |
|   H_2_3    |      0.000038 | (Indisponível) |
|   H_2_5    |      0.000031 | (Indisponível) |
|   H_0_3    |      0.000031 | (Indisponível) |
...
- `cnn1_partida095_jogada021_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida095_jogada021_vit_mm.md` — este relatório
- `cnn1_partida095_jogada021_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida095_jogada021_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
