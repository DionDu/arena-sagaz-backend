# Caixa perdida — partida 71, jogada 22
...
## Placar
- **No momento da decisão:** CNN **1** × **2** Minimax
...
|:----------:|:-------------:|:--------------:|
|   V_7_0    |      0.993175 | ⭐ (Escolhida)  |
|   H_6_1    |      0.005032 |                |
|   H_8_1    |      0.000563 | (Indisponível) |
|   V_5_0    |      0.000160 | (Indisponível) |
|   H_6_3    |      0.000112 |                |
|   H_2_5    |      0.000107 |                |
|   V_1_6    |      0.000103 |                |
|   H_6_5    |      0.000082 |                |
...
- `cnn2_partida071_jogada022_emp.png` — visualização com numeração de arestas
- `cnn2_partida071_jogada022_emp.md` — este relatório
- `cnn2_partida071_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida071_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
