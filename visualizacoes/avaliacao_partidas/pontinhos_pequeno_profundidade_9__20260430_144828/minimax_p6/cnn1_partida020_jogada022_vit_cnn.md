# Caixa perdida — partida 20, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.997221 | ⭐ (Escolhida)  |
|   V_1_2    |      0.001948 |                |
|   H_0_1    |      0.000591 | (Indisponível) |
|   H_8_1    |      0.000047 |                |
|   H_8_5    |      0.000027 |                |
...
- `cnn1_partida020_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida020_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida020_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida020_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
