# Caixa perdida — partida 50, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.975082 | ⭐ (Escolhida)  |
|   H_6_1    |      0.021998 |                |
|   V_7_0    |      0.000417 | (Indisponível) |
|   V_5_6    |      0.000417 |                |
|   V_5_0    |      0.000376 | (Indisponível) |
|   V_3_6    |      0.000263 |                |
|   V_5_4    |      0.000212 |                |
|   H_4_3    |      0.000191 |                |
|   V_5_2    |      0.000138 | (Indisponível) |
|   V_3_4    |      0.000120 |                |
|   H_4_1    |      0.000087 | (Indisponível) |
|   V_3_0    |      0.000064 | (Indisponível) |
|   V_7_4    |      0.000060 | (Indisponível) |
|   H_6_3    |      0.000060 | (Indisponível) |
|   H_8_3    |      0.000060 | (Indisponível) |
|   V_7_6    |      0.000059 | (Indisponível) |
|   V_3_2    |      0.000057 | (Indisponível) |
|   H_8_5    |      0.000052 | (Indisponível) |
|   V_7_2    |      0.000041 | (Indisponível) |
|   H_4_5    |      0.000039 | (Indisponível) |
|   H_6_5    |      0.000036 | (Indisponível) |
|   H_0_1    |      0.000025 | (Indisponível) |
|   H_2_1    |      0.000024 | (Indisponível) |
|   H_0_5    |      0.000023 | (Indisponível) |
|   H_2_5    |      0.000018 | (Indisponível) |
|   H_0_3    |      0.000018 | (Indisponível) |
|   V_1_0    |      0.000018 | (Indisponível) |
|   H_2_3    |      0.000016 | (Indisponível) |
|   V_1_6    |      0.000015 | (Indisponível) |
|   V_1_2    |      0.000008 | (Indisponível) |
|   V_1_4    |      0.000004 | (Indisponível) |
...
- `cnn2_partida050_jogada025_vit_mm.png` — visualização com numeração de arestas
- `cnn2_partida050_jogada025_vit_mm.md` — este relatório
- `cnn2_partida050_jogada025_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida050_jogada025_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
