# Caixa perdida — partida 76, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.993536 | ⭐ (Escolhida)  |
|   V_1_2    |      0.005021 |                |
|   H_0_1    |      0.000873 | (Indisponível) |
|   V_3_0    |      0.000132 |                |
|   H_4_1    |      0.000058 |                |
|   H_8_5    |      0.000053 |                |
|   V_7_0    |      0.000033 | (Indisponível) |
|   V_7_6    |      0.000025 | (Indisponível) |
|   V_7_2    |      0.000025 |                |
...
- `cnn1_partida076_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida076_jogada022_emp.md` — este relatório
- `cnn1_partida076_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida076_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
