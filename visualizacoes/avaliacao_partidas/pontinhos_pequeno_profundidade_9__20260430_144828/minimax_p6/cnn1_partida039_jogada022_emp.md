# Caixa perdida — partida 39, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.995585 | ⭐ (Escolhida)  |
|   H_2_1    |      0.002772 |                |
|   H_0_1    |      0.001002 | (Indisponível) |
|   H_8_1    |      0.000151 |                |
|   V_7_2    |      0.000075 |                |
|   H_8_5    |      0.000062 |                |
|   V_7_0    |      0.000037 | (Indisponível) |
|   V_5_0    |      0.000037 | (Indisponível) |
|   H_8_3    |      0.000029 | (Indisponível) |
|   H_6_1    |      0.000027 | (Indisponível) |
|   H_6_5    |      0.000024 |                |
...
- `cnn1_partida039_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida039_jogada022_emp.md` — este relatório
- `cnn1_partida039_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida039_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
