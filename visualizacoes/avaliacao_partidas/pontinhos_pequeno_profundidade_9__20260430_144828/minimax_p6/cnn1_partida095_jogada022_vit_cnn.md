# Caixa perdida — partida 95, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.995871 | ⭐ (Escolhida)  |
|   H_2_1    |      0.002254 |                |
|   H_0_1    |      0.001423 | (Indisponível) |
|   H_8_3    |      0.000071 |                |
|   V_5_0    |      0.000042 | (Indisponível) |
|   V_1_6    |      0.000032 |                |
|   V_7_4    |      0.000028 |                |
...
- `cnn1_partida095_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida095_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida095_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida095_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
