# Caixa perdida — partida 21, jogada 19
...
|:----------:|:-------------:|:--------------:|
|   V_5_6    |      0.811102 | ⭐ (Escolhida)  |
|   H_6_5    |      0.174593 |                |
|   H_8_3    |      0.002878 |                |
|   H_6_3    |      0.001282 |                |
|   V_7_6    |      0.001137 | (Indisponível) |
|   V_5_4    |      0.001018 | (Indisponível) |
|   H_0_5    |      0.000850 |                |
|   V_1_0    |      0.000753 |                |
|   H_8_5    |      0.000634 | (Indisponível) |
|   H_2_5    |      0.000608 |                |
|   V_7_4    |      0.000486 | (Indisponível) |
|   V_7_0    |      0.000463 |                |
|   H_4_3    |      0.000378 |                |
|   H_0_1    |      0.000333 | (Indisponível) |
|   V_7_2    |      0.000332 | (Indisponível) |
|   V_3_6    |      0.000326 | (Indisponível) |
|   H_4_1    |      0.000319 |                |
|   V_5_0    |      0.000294 | (Indisponível) |
|   V_5_2    |      0.000281 | (Indisponível) |
|   H_2_1    |      0.000273 |                |
|   H_6_1    |      0.000268 |                |
|   H_8_1    |      0.000265 | (Indisponível) |
|   V_1_6    |      0.000228 | (Indisponível) |
|   H_4_5    |      0.000208 | (Indisponível) |
|   V_3_2    |      0.000177 | (Indisponível) |
|   V_3_4    |      0.000159 |                |
|   V_3_0    |      0.000153 | (Indisponível) |
|   H_0_3    |      0.000060 | (Indisponível) |
|   H_2_3    |      0.000054 | (Indisponível) |
|   V_1_2    |      0.000046 | (Indisponível) |
|   V_1_4    |      0.000045 | (Indisponível) |
...
- `cnn2_partida021_jogada019_vit_mm.png` — visualização com numeração de arestas
- `cnn2_partida021_jogada019_vit_mm.md` — este relatório
- `cnn2_partida021_jogada019_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida021_jogada019_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
