# Caixa perdida — partida 53, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.998820 | ⭐ (Escolhida)  |
|   V_1_2    |      0.000619 |                |
|   H_0_1    |      0.000514 | (Indisponível) |
...
- `cnn1_partida053_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida053_jogada024_vit_cnn.md` — este relatório
- `cnn1_partida053_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida053_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
