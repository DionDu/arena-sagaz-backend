# Caixa perdida — partida 38, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.996795 | ⭐ (Escolhida)  |
|   H_2_1    |      0.001636 |                |
|   H_0_1    |      0.001148 | (Indisponível) |
|   H_0_3    |      0.000074 |                |
|   V_7_6    |      0.000048 |                |
...
- `cnn1_partida038_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida038_jogada022_emp.md` — este relatório
- `cnn1_partida038_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida038_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
