# Caixa perdida — partida 7, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.981516 | ⭐ (Escolhida)  |
|   H_2_5    |      0.015131 |                |
|   H_0_5    |      0.001445 | (Indisponível) |
...
|   H_6_1    |      0.000110 |                |
|   H_2_1    |      0.000090 |                |
|   V_5_0    |      0.000079 | (Indisponível) |
|   V_7_0    |      0.000072 | (Indisponível) |
|   H_8_5    |      0.000050 | (Indisponível) |
|   V_3_0    |      0.000043 | (Indisponível) |
...
- `cnn1_partida007_jogada025_emp.png` — visualização com numeração de arestas
- `cnn1_partida007_jogada025_emp.md` — este relatório
- `cnn1_partida007_jogada025_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida007_jogada025_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
