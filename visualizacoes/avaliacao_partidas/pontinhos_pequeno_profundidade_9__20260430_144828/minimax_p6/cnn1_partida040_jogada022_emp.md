# Caixa perdida — partida 40, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   H_0_1    |      0.994446 | ⭐ (Escolhida)  |
|   H_2_1    |      0.003222 |                |
|   V_1_0    |      0.001768 | (Indisponível) |
|   H_8_3    |      0.000085 |                |
...
- `cnn1_partida040_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida040_jogada022_emp.md` — este relatório
- `cnn1_partida040_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida040_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
