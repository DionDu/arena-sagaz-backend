# Caixa perdida — partida 86, jogada 20
...
|   V_7_0    |      0.000018 |                |
|   H_4_5    |      0.000016 |                |
|   H_8_3    |      0.000015 | (Indisponível) |
|   V_5_2    |      0.000013 | (Indisponível) |
|   V_5_0    |      0.000013 | (Indisponível) |
|   V_5_4    |      0.000012 | (Indisponível) |
|   H_6_1    |      0.000011 |                |
|   H_2_5    |      0.000009 | (Indisponível) |
|   V_1_0    |      0.000009 | (Indisponível) |
|   V_7_6    |      0.000007 | (Indisponível) |
|   V_5_6    |      0.000007 | (Indisponível) |
|   H_2_1    |      0.000006 |                |
...
- `cnn1_partida086_jogada020_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida086_jogada020_vit_cnn.md` — este relatório
- `cnn1_partida086_jogada020_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida086_jogada020_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
