...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.986395 | ⭐ (Escolhida)  |
|   V_1_4    |      0.012532 |                |
|   V_1_0    |      0.000212 |                |
|   V_1_6    |      0.000181 | (Indisponível) |
|   H_0_5    |      0.000173 | (Indisponível) |
|   H_2_1    |      0.000117 |                |
...
- `cnn1_partida091_jogada025_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida091_jogada025_vit_mm.md` — este relatório
- `cnn1_partida091_jogada025_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida091_jogada025_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
