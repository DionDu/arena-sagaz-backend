# Caixa perdida — partida 4, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.994825 | ⭐ (Escolhida)  |
|   V_1_4    |      0.004700 |                |
|   V_1_6    |      0.000125 | (Indisponível) |
|   H_0_5    |      0.000104 | (Indisponível) |
|   H_8_5    |      0.000026 |                |
|   H_8_1    |      0.000018 |                |
...
- `cnn1_partida004_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida004_jogada022_emp.md` — este relatório
- `cnn1_partida004_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida004_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
