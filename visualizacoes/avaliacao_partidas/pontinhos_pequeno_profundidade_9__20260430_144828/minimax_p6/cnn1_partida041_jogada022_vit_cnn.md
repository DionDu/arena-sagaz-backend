# Caixa perdida — partida 41, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.994207 | ⭐ (Escolhida)  |
|   V_1_4    |      0.005371 |                |
|   V_1_6    |      0.000090 | (Indisponível) |
|   H_0_5    |      0.000080 | (Indisponível) |
|   H_8_5    |      0.000028 |                |
|   V_7_4    |      0.000021 |                |
|   H_8_1    |      0.000020 |                |
|   H_4_1    |      0.000017 |                |
|   H_6_1    |      0.000014 |                |
|   V_7_6    |      0.000013 | (Indisponível) |
|   H_0_1    |      0.000013 | (Indisponível) |
|   V_3_0    |      0.000011 | (Indisponível) |
|   V_3_6    |      0.000011 | (Indisponível) |
|   V_3_2    |      0.000010 |                |
|   H_2_5    |      0.000010 | (Indisponível) |
|   V_1_0    |      0.000009 | (Indisponível) |
|   H_8_3    |      0.000009 | (Indisponível) |
...
- `cnn1_partida041_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida041_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida041_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida041_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
