...
|:----------:|:-------------:|:--------------:|
|   V_3_6    |      0.981836 | ⭐ (Escolhida)  |
|   H_4_5    |      0.017355 |                |
|   V_5_6    |      0.000139 | (Indisponível) |
|   V_1_0    |      0.000102 |                |
|   V_7_0    |      0.000056 |                |
|   V_7_6    |      0.000050 | (Indisponível) |
|   H_0_1    |      0.000047 | (Indisponível) |
|   H_4_1    |      0.000046 |                |
...
- `cnn1_partida000_jogada025_emp.png` — visualização com numeração de arestas
- `cnn1_partida000_jogada025_emp.md` — este relatório
- `cnn1_partida000_jogada025_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida000_jogada025_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
