# Caixa perdida — partida 33, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.997340 | ⭐ (Escolhida)  |
|   H_2_1    |      0.001358 |                |
|   H_0_1    |      0.000853 | (Indisponível) |
|   H_0_3    |      0.000128 |                |
|   V_7_6    |      0.000083 |                |
|   V_7_4    |      0.000031 |                |
...
- `cnn1_partida033_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida033_jogada024_vit_cnn.md` — este relatório
- `cnn1_partida033_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida033_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
