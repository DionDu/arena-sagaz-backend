# Caixa perdida — partida 51, jogada 20
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.902329 | ⭐ (Escolhida)  |
|   V_1_2    |      0.095641 |                |
|   V_3_0    |      0.000473 |                |
|   H_0_1    |      0.000372 | (Indisponível) |
|   H_2_1    |      0.000188 | (Indisponível) |
|   H_4_1    |      0.000180 |                |
|   V_1_0    |      0.000165 | (Indisponível) |
|   H_6_1    |      0.000122 |                |
|   V_7_0    |      0.000093 |                |
|   V_1_4    |      0.000035 | (Indisponível) |
|   V_3_2    |      0.000033 | (Indisponível) |
|   V_5_0    |      0.000032 | (Indisponível) |
|   V_7_6    |      0.000031 | (Indisponível) |
...
|   V_5_6    |      0.000018 | (Indisponível) |
|   H_6_3    |      0.000017 |                |
|   V_1_6    |      0.000016 | (Indisponível) |
...
- `cnn1_partida051_jogada020_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida051_jogada020_vit_cnn.md` — este relatório
- `cnn1_partida051_jogada020_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida051_jogada020_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
