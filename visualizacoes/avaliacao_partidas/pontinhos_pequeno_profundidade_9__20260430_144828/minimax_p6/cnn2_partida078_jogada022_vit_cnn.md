# Caixa perdida — partida 78, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_3_4    |      0.987216 | ⭐ (Escolhida)  |
|   H_4_5    |      0.012029 |                |
|   V_3_6    |      0.000538 | (Indisponível) |
|   H_4_3    |      0.000061 |                |
|   H_2_3    |      0.000034 |                |
|   V_5_6    |      0.000030 | (Indisponível) |
|   H_6_5    |      0.000015 | (Indisponível) |
...
- `cnn2_partida078_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida078_jogada022_vit_cnn.md` — este relatório
- `cnn2_partida078_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida078_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
