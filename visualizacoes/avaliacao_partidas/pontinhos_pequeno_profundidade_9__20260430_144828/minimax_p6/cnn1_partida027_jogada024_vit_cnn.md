# Caixa perdida — partida 27, jogada 24
...
## Placar
- **No momento da decisão:** CNN **4** × **1** Minimax
...
|:----------:|:-------------:|:--------------:|
|   V_5_0    |      0.996777 | ⭐ (Escolhida)  |
|   H_4_1    |      0.002770 |                |
|   H_8_1    |      0.000093 |                |
|   V_3_0    |      0.000058 | (Indisponível) |
|   V_7_6    |      0.000054 |                |
|   H_8_5    |      0.000038 | (Indisponível) |
|   V_7_2    |      0.000035 |                |
|   H_6_5    |      0.000020 |                |
|   V_7_0    |      0.000020 | (Indisponível) |
...
- `cnn1_partida027_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida027_jogada024_vit_cnn.md` — este relatório
- `cnn1_partida027_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida027_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
