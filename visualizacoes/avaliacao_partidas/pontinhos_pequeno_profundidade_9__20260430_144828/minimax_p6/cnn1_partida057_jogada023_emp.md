# Caixa perdida — partida 57, jogada 23
...
- `cnn1_partida057_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida057_jogada023_emp.md` — este relatório
- `cnn1_partida057_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida057_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
