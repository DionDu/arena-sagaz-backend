# Caixa perdida — partida 49, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.988525 | ⭐ (Escolhida)  |
|   H_6_1    |      0.009913 |                |
|   H_8_3    |      0.000438 |                |
|   V_7_0    |      0.000345 | (Indisponível) |
|   V_5_0    |      0.000123 | (Indisponível) |
|   H_6_3    |      0.000122 |                |
|   V_1_6    |      0.000087 |                |
...
- `cnn1_partida049_jogada024_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida049_jogada024_vit_mm.md` — este relatório
- `cnn1_partida049_jogada024_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida049_jogada024_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
