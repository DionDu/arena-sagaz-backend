# Caixa perdida — partida 16, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   V_5_0    |      0.998287 | ⭐ (Escolhida)  |
|   H_6_1    |      0.001609 |                |
|   H_8_1    |      0.000017 | (Indisponível) |
...
|   H_4_5    |      0.000005 |                |
|   H_6_5    |      0.000004 |                |
|   V_3_0    |      0.000004 | (Indisponível) |
|   V_3_2    |      0.000004 | (Indisponível) |
|   V_5_6    |      0.000004 | (Indisponível) |
|   V_5_4    |      0.000003 | (Indisponível) |
|   V_3_6    |      0.000002 | (Indisponível) |
|   V_3_4    |      0.000002 |                |
|   H_8_3    |      0.000002 | (Indisponível) |
|   V_5_2    |      0.000001 | (Indisponível) |
|   H_0_1    |      0.000001 | (Indisponível) |
|   V_1_0    |      0.000001 | (Indisponível) |
|   H_0_5    |      0.000001 | (Indisponível) |
|   H_2_5    |      0.000001 | (Indisponível) |
|   V_1_6    |      0.000001 | (Indisponível) |
|   H_2_1    |      0.000000 | (Indisponível) |
|   H_4_1    |      0.000000 | (Indisponível) |
|   H_0_3    |      0.000000 | (Indisponível) |
|   V_1_2    |      0.000000 | (Indisponível) |
...
- `cnn2_partida016_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida016_jogada024_vit_cnn.md` — este relatório
- `cnn2_partida016_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida016_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
