# Caixa perdida — partida 69, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.996179 | ⭐ (Escolhida)  |
|   H_2_1    |      0.002135 |                |
|   H_0_1    |      0.001303 | (Indisponível) |
|   H_8_5    |      0.000077 |                |
|   H_0_5    |      0.000031 |                |
|   V_3_2    |      0.000027 | (Indisponível) |
|   H_6_5    |      0.000026 |                |
|   V_5_0    |      0.000026 | (Indisponível) |
|   H_4_5    |      0.000015 |                |
|   V_7_6    |      0.000014 | (Indisponível) |
...
- `cnn1_partida069_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida069_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida069_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida069_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
