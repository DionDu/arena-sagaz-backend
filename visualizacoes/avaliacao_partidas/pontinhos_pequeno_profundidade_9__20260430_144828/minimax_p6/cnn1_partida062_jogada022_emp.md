# Caixa perdida — partida 62, jogada 22
...
- `cnn1_partida062_jogada022_emp.png` — visualização com numeração de arestas
- `cnn1_partida062_jogada022_emp.md` — este relatório
- `cnn1_partida062_jogada022_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida062_jogada022_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
