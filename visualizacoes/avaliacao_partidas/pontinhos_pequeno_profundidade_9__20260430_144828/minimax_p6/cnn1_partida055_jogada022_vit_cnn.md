# Caixa perdida — partida 55, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   H_0_3    |      0.987095 | ⭐ (Escolhida)  |
|   H_2_3    |      0.011378 |                |
|   H_4_1    |      0.000145 |                |
|   H_8_5    |      0.000138 |                |
|   V_3_0    |      0.000111 |                |
|   V_3_6    |      0.000092 | (Indisponível) |
|   V_7_6    |      0.000085 | (Indisponível) |
|   V_5_6    |      0.000078 | (Indisponível) |
|   V_5_0    |      0.000074 | (Indisponível) |
|   V_3_2    |      0.000066 | (Indisponível) |
|   H_6_5    |      0.000066 |                |
|   H_8_3    |      0.000057 | (Indisponível) |
|   V_7_2    |      0.000052 |                |
|   H_6_1    |      0.000052 |                |
|   V_7_4    |      0.000050 | (Indisponível) |
|   H_6_3    |      0.000045 |                |
|   V_5_4    |      0.000044 |                |
|   V_7_0    |      0.000041 | (Indisponível) |
|   H_4_5    |      0.000040 | (Indisponível) |
|   H_8_1    |      0.000036 | (Indisponível) |
|   H_4_3    |      0.000030 | (Indisponível) |
|   H_0_5    |      0.000030 | (Indisponível) |
|   V_5_2    |      0.000030 | (Indisponível) |
|   H_0_1    |      0.000028 | (Indisponível) |
|   V_1_4    |      0.000026 | (Indisponível) |
|   V_3_4    |      0.000026 | (Indisponível) |
|   V_1_6    |      0.000023 | (Indisponível) |
|   V_1_0    |      0.000023 | (Indisponível) |
...
- `cnn1_partida055_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida055_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida055_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida055_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
