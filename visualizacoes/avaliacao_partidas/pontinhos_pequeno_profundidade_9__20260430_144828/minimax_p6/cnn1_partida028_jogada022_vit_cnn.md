# Caixa perdida — partida 28, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.982714 | ⭐ (Escolhida)  |
|   H_6_1    |      0.014912 |                |
|   V_7_0    |      0.000392 | (Indisponível) |
|   H_0_1    |      0.000365 |                |
|   H_8_3    |      0.000278 |                |
|   H_6_3    |      0.000241 |                |
|   V_5_0    |      0.000171 | (Indisponível) |
|   V_5_2    |      0.000121 | (Indisponível) |
|   V_1_2    |      0.000113 |                |
|   V_5_4    |      0.000059 |                |
|   H_2_3    |      0.000050 |                |
|   H_4_1    |      0.000048 | (Indisponível) |
|   V_7_4    |      0.000046 | (Indisponível) |
...
- `cnn1_partida028_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida028_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida028_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida028_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
