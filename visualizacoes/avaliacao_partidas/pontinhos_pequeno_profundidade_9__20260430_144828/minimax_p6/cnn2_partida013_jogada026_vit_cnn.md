# Caixa perdida — partida 13, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.957144 | ⭐ (Escolhida)  |
|   V_3_2    |      0.041928 |                |
|   V_5_4    |      0.000069 |                |
|   V_5_6    |      0.000063 | (Indisponível) |
|   H_6_5    |      0.000058 |                |
|   H_0_1    |      0.000050 | (Indisponível) |
|   V_7_4    |      0.000050 |                |
|   V_5_0    |      0.000045 | (Indisponível) |
|   H_0_5    |      0.000042 | (Indisponível) |
|   H_4_3    |      0.000039 | (Indisponível) |
|   V_7_6    |      0.000038 | (Indisponível) |
|   V_3_6    |      0.000036 | (Indisponível) |
|   H_4_5    |      0.000036 | (Indisponível) |
|   V_1_0    |      0.000036 | (Indisponível) |
|   H_8_5    |      0.000035 | (Indisponível) |
|   H_6_3    |      0.000034 |                |
|   V_5_2    |      0.000034 | (Indisponível) |
|   H_2_5    |      0.000030 | (Indisponível) |
|   H_8_3    |      0.000029 | (Indisponível) |
|   H_4_1    |      0.000026 | (Indisponível) |
|   V_3_4    |      0.000025 | (Indisponível) |
|   H_2_3    |      0.000023 | (Indisponível) |
|   V_1_6    |      0.000022 | (Indisponível) |
|   H_0_3    |      0.000021 | (Indisponível) |
|   H_2_1    |      0.000017 | (Indisponível) |
|   V_1_2    |      0.000016 | (Indisponível) |
|   V_1_4    |      0.000013 | (Indisponível) |
|   H_8_1    |      0.000012 | (Indisponível) |
|   H_6_1    |      0.000011 | (Indisponível) |
|   V_7_2    |      0.000009 | (Indisponível) |
|   V_7_0    |      0.000009 | (Indisponível) |
...
- `cnn2_partida013_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida013_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida013_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida013_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
