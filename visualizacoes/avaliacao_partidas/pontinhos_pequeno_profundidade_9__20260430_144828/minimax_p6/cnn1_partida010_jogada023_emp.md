# Caixa perdida — partida 10, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_7_0    |      0.986922 | ⭐ (Escolhida)  |
|   H_6_1    |      0.010340 |                |
|   H_8_1    |      0.001003 | (Indisponível) |
|   V_5_0    |      0.000245 | (Indisponível) |
|   V_7_6    |      0.000233 |                |
|   H_6_5    |      0.000135 |                |
|   V_1_6    |      0.000117 |                |
|   H_8_5    |      0.000087 | (Indisponível) |
|   H_8_3    |      0.000077 | (Indisponível) |
|   H_4_5    |      0.000073 |                |
|   H_0_5    |      0.000065 | (Indisponível) |
|   V_7_4    |      0.000063 | (Indisponível) |
|   V_5_2    |      0.000058 | (Indisponível) |
|   H_6_3    |      0.000054 | (Indisponível) |
|   H_4_1    |      0.000049 | (Indisponível) |
|   V_1_4    |      0.000047 |                |
|   V_5_6    |      0.000046 | (Indisponível) |
|   H_2_5    |      0.000043 | (Indisponível) |
|   V_3_6    |      0.000043 | (Indisponível) |
|   V_7_2    |      0.000035 | (Indisponível) |
|   H_0_3    |      0.000034 | (Indisponível) |
|   V_5_4    |      0.000032 | (Indisponível) |
|   V_3_2    |      0.000029 | (Indisponível) |
|   H_2_3    |      0.000029 |                |
|   V_3_0    |      0.000026 | (Indisponível) |
|   V_3_4    |      0.000024 |                |
|   H_0_1    |      0.000020 | (Indisponível) |
|   H_4_3    |      0.000020 | (Indisponível) |
|   V_1_2    |      0.000018 | (Indisponível) |
|   H_2_1    |      0.000018 | (Indisponível) |
|   V_1_0    |      0.000014 | (Indisponível) |
...
- `cnn1_partida010_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida010_jogada023_emp.md` — este relatório
- `cnn1_partida010_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida010_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
