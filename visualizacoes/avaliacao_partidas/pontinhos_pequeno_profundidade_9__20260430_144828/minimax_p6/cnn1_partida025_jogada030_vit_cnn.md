# Caixa perdida — partida 25, jogada 30
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.984867 | ⭐ (Escolhida)  |
|   V_1_2    |      0.014108 |                |
|   H_0_1    |      0.000866 | (Indisponível) |
|   H_0_3    |      0.000064 | (Indisponível) |
...
- `cnn1_partida025_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida025_jogada030_vit_cnn.md` — este relatório
- `cnn1_partida025_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida025_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
