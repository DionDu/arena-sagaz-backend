# Caixa perdida — partida 21, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.963676 | ⭐ (Escolhida)  |
|   H_6_1    |      0.031751 |                |
|   V_7_4    |      0.001019 |                |
|   H_6_3    |      0.000493 |                |
|   H_6_5    |      0.000466 |                |
|   V_5_0    |      0.000409 | (Indisponível) |
|   V_7_0    |      0.000404 | (Indisponível) |
|   V_5_4    |      0.000392 |                |
|   V_5_2    |      0.000221 | (Indisponível) |
|   H_4_1    |      0.000186 | (Indisponível) |
|   V_5_6    |      0.000155 | (Indisponível) |
|   V_7_6    |      0.000141 | (Indisponível) |
|   H_8_5    |      0.000127 | (Indisponível) |
|   V_3_0    |      0.000084 | (Indisponível) |
|   H_8_3    |      0.000078 | (Indisponível) |
|   V_7_2    |      0.000066 | (Indisponível) |
|   H_4_5    |      0.000062 | (Indisponível) |
|   V_3_6    |      0.000052 | (Indisponível) |
|   H_2_1    |      0.000029 | (Indisponível) |
|   V_3_2    |      0.000029 | (Indisponível) |
|   H_4_3    |      0.000024 | (Indisponível) |
|   H_0_1    |      0.000022 | (Indisponível) |
|   V_1_0    |      0.000018 | (Indisponível) |
|   V_3_4    |      0.000018 | (Indisponível) |
|   H_0_5    |      0.000018 | (Indisponível) |
|   H_0_3    |      0.000017 | (Indisponível) |
|   H_2_5    |      0.000014 | (Indisponível) |
...
- `cnn1_partida021_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida021_jogada026_vit_cnn.md` — este relatório
- `cnn1_partida021_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida021_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
