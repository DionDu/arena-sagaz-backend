...
|:----------:|:-------------:|:--------------:|
|   V_7_0    |      0.901195 | ⭐ (Escolhida)  |
|   H_6_1    |      0.086808 |                |
|   V_1_0    |      0.002698 |                |
|   V_1_2    |      0.002251 |                |
|   V_1_6    |      0.001209 |                |
|   H_8_1    |      0.001186 | (Indisponível) |
|   V_1_4    |      0.000984 |                |
|   V_5_0    |      0.000943 | (Indisponível) |
|   H_0_1    |      0.000537 | (Indisponível) |
|   H_0_5    |      0.000313 | (Indisponível) |
|   H_4_1    |      0.000312 | (Indisponível) |
|   H_2_1    |      0.000311 | (Indisponível) |
|   H_0_3    |      0.000219 | (Indisponível) |
|   V_3_0    |      0.000156 | (Indisponível) |
|   H_2_5    |      0.000105 | (Indisponível) |
|   V_7_2    |      0.000099 | (Indisponível) |
|   V_5_2    |      0.000092 | (Indisponível) |
|   H_8_3    |      0.000078 | (Indisponível) |
|   H_8_5    |      0.000072 | (Indisponível) |
|   V_7_4    |      0.000067 | (Indisponível) |
|   V_7_6    |      0.000066 | (Indisponível) |
|   V_3_6    |      0.000060 | (Indisponível) |
|   H_6_5    |      0.000049 | (Indisponível) |
|   V_5_6    |      0.000038 | (Indisponível) |
|   H_6_3    |      0.000037 | (Indisponível) |
|   V_3_2    |      0.000027 | (Indisponível) |
|   H_2_3    |      0.000023 | (Indisponível) |
|   V_5_4    |      0.000021 | (Indisponível) |
|   H_4_5    |      0.000019 | (Indisponível) |
|   H_4_3    |      0.000015 | (Indisponível) |
...
- `cnn2_partida075_jogada026_emp.png` — visualização com numeração de arestas
- `cnn2_partida075_jogada026_emp.md` — este relatório
- `cnn2_partida075_jogada026_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida075_jogada026_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
