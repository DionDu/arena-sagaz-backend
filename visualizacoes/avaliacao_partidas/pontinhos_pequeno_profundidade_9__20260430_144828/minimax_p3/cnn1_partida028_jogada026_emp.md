# Caixa perdida — partida 28, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   H_8_5    |      0.944485 | ⭐ (Escolhida)  |
|   H_6_5    |      0.049702 |                |
|   V_7_6    |      0.001211 | (Indisponível) |
|   H_4_1    |      0.000844 |                |
|   H_8_1    |      0.000738 |                |
|   V_3_0    |      0.000436 |                |
|   V_5_6    |      0.000405 | (Indisponível) |
|   H_6_1    |      0.000322 |                |
|   V_5_0    |      0.000243 | (Indisponível) |
|   V_5_4    |      0.000219 | (Indisponível) |
|   H_4_5    |      0.000186 | (Indisponível) |
|   V_7_2    |      0.000180 | (Indisponível) |
|   V_7_0    |      0.000175 | (Indisponível) |
|   H_6_3    |      0.000119 | (Indisponível) |
|   H_8_3    |      0.000111 | (Indisponível) |
|   V_3_6    |      0.000108 | (Indisponível) |
|   V_5_2    |      0.000078 | (Indisponível) |
|   V_7_4    |      0.000076 | (Indisponível) |
|   H_2_5    |      0.000048 | (Indisponível) |
|   H_0_1    |      0.000044 | (Indisponível) |
|   V_3_2    |      0.000042 | (Indisponível) |
|   H_2_1    |      0.000039 | (Indisponível) |
|   V_1_0    |      0.000037 | (Indisponível) |
|   V_1_6    |      0.000032 | (Indisponível) |
|   H_0_5    |      0.000032 | (Indisponível) |
|   H_4_3    |      0.000027 | (Indisponível) |
|   V_3_4    |      0.000019 | (Indisponível) |
|   H_0_3    |      0.000015 | (Indisponível) |
...
- `cnn1_partida028_jogada026_emp.png` — visualização com numeração de arestas
- `cnn1_partida028_jogada026_emp.md` — este relatório
- `cnn1_partida028_jogada026_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida028_jogada026_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
