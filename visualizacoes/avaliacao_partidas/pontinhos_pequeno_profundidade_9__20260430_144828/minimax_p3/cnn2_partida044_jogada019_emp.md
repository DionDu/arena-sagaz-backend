# Caixa perdida — partida 44, jogada 19
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.523753 | ⭐ (Escolhida)  |
|   H_4_1    |      0.465809 |                |
|   V_1_0    |      0.001981 |                |
|   V_1_2    |      0.000968 |                |
|   V_5_2    |      0.000640 | (Indisponível) |
|   H_0_1    |      0.000558 | (Indisponível) |
|   H_2_5    |      0.000505 |                |
|   V_5_0    |      0.000461 | (Indisponível) |
|   H_8_3    |      0.000441 |                |
|   H_0_5    |      0.000427 |                |
|   H_6_3    |      0.000406 |                |
|   V_7_6    |      0.000369 |                |
|   H_4_5    |      0.000354 |                |
|   H_6_5    |      0.000320 |                |
|   H_6_1    |      0.000266 | (Indisponível) |
|   V_1_6    |      0.000262 | (Indisponível) |
|   V_3_2    |      0.000249 | (Indisponível) |
|   V_5_6    |      0.000248 | (Indisponível) |
|   V_3_6    |      0.000242 | (Indisponível) |
|   H_2_3    |      0.000236 |                |
|   V_5_4    |      0.000202 | (Indisponível) |
|   H_4_3    |      0.000191 |                |
|   H_0_3    |      0.000178 | (Indisponível) |
|   H_8_5    |      0.000175 | (Indisponível) |
|   H_2_1    |      0.000167 | (Indisponível) |
|   V_1_4    |      0.000138 | (Indisponível) |
|   V_7_4    |      0.000116 | (Indisponível) |
|   V_7_2    |      0.000106 | (Indisponível) |
|   V_7_0    |      0.000088 | (Indisponível) |
|   H_8_1    |      0.000088 | (Indisponível) |
|   V_3_4    |      0.000058 | (Indisponível) |
...
- `cnn2_partida044_jogada019_emp.png` — visualização com numeração de arestas
- `cnn2_partida044_jogada019_emp.md` — este relatório
- `cnn2_partida044_jogada019_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida044_jogada019_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
