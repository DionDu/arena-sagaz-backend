# Caixa perdida — partida 32, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.928694 | ⭐ (Escolhida)  |
|   H_2_5    |      0.064228 |                |
|   H_0_5    |      0.001878 | (Indisponível) |
|   V_3_6    |      0.000907 | (Indisponível) |
|   H_8_1    |      0.000884 |                |
|   H_4_1    |      0.000693 |                |
|   V_3_0    |      0.000512 |                |
|   H_6_1    |      0.000507 |                |
|   V_5_0    |      0.000260 | (Indisponível) |
|   V_7_0    |      0.000222 | (Indisponível) |
|   V_5_2    |      0.000154 | (Indisponível) |
|   H_8_5    |      0.000123 | (Indisponível) |
|   H_4_5    |      0.000116 | (Indisponível) |
|   V_5_6    |      0.000104 | (Indisponível) |
|   V_7_6    |      0.000080 | (Indisponível) |
|   H_0_1    |      0.000078 | (Indisponível) |
|   H_8_3    |      0.000065 | (Indisponível) |
|   V_1_0    |      0.000065 | (Indisponível) |
|   V_7_2    |      0.000060 | (Indisponível) |
|   H_6_5    |      0.000059 | (Indisponível) |
|   V_5_4    |      0.000050 | (Indisponível) |
|   V_7_4    |      0.000049 | (Indisponível) |
|   H_2_1    |      0.000043 | (Indisponível) |
|   H_6_3    |      0.000041 | (Indisponível) |
|   V_3_2    |      0.000034 | (Indisponível) |
|   V_3_4    |      0.000024 | (Indisponível) |
|   H_0_3    |      0.000022 | (Indisponível) |
|   H_4_3    |      0.000014 | (Indisponível) |
|   V_1_2    |      0.000014 | (Indisponível) |
...
- `cnn1_partida032_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida032_jogada026_vit_cnn.md` — este relatório
- `cnn1_partida032_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida032_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
