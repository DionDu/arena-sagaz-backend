...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.949861 | ⭐ (Escolhida)  |
|   V_1_2    |      0.047953 |                |
|   H_0_1    |      0.000672 | (Indisponível) |
|   H_4_5    |      0.000223 |                |
|   V_5_4    |      0.000223 |                |
|   V_3_4    |      0.000152 |                |
|   H_4_3    |      0.000129 |                |
|   H_0_3    |      0.000071 | (Indisponível) |
|   H_2_3    |      0.000070 | (Indisponível) |
...
|   V_7_6    |      0.000042 | (Indisponível) |
|   V_3_2    |      0.000039 | (Indisponível) |
|   H_8_3    |      0.000038 | (Indisponível) |
|   H_2_5    |      0.000035 | (Indisponível) |
|   V_7_4    |      0.000032 | (Indisponível) |
|   H_6_3    |      0.000025 | (Indisponível) |
|   V_3_0    |      0.000023 | (Indisponível) |
|   V_7_0    |      0.000022 | (Indisponível) |
|   H_0_5    |      0.000022 | (Indisponível) |
|   V_1_4    |      0.000020 | (Indisponível) |
...
- `cnn2_partida001_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida001_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida001_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida001_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
