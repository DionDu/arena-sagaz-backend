# Caixa perdida — partida 42, jogada 22
...
## Placar
- **No momento da decisão:** CNN **3** × **0** Minimax
...
|:----------:|:-------------:|:--------------:|
|   H_0_5    |      0.997538 | ⭐ (Escolhida)  |
|   V_1_6    |      0.001297 | (Indisponível) |
|   V_1_4    |      0.000848 |                |
|   V_7_6    |      0.000040 |                |
|   H_0_3    |      0.000037 | (Indisponível) |
|   H_8_1    |      0.000030 |                |
...
- `cnn1_partida042_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida042_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida042_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida042_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
