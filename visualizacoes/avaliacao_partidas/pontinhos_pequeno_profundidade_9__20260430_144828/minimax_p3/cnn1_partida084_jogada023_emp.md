# Caixa perdida — partida 84, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.995662 | ⭐ (Escolhida)  |
|   H_2_1    |      0.002432 |                |
|   H_0_1    |      0.001473 | (Indisponível) |
|   H_8_5    |      0.000084 |                |
|   V_1_6    |      0.000034 |                |
|   V_3_2    |      0.000030 | (Indisponível) |
|   V_5_0    |      0.000029 | (Indisponível) |
|   H_6_5    |      0.000029 |                |
|   H_4_5    |      0.000019 |                |
|   V_7_6    |      0.000016 | (Indisponível) |
|   V_3_6    |      0.000016 | (Indisponível) |
...
- `cnn1_partida084_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida084_jogada023_emp.md` — este relatório
- `cnn1_partida084_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida084_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
