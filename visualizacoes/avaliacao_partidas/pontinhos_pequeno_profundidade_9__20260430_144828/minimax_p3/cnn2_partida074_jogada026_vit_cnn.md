# Caixa perdida — partida 74, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_1_6    |      0.940181 | ⭐ (Escolhida)  |
|   H_2_5    |      0.053483 |                |
|   H_0_5    |      0.002766 | (Indisponível) |
|   V_3_2    |      0.000776 |                |
|   H_2_3    |      0.000473 |                |
|   V_3_6    |      0.000438 | (Indisponível) |
|   V_1_2    |      0.000392 |                |
|   H_0_1    |      0.000277 | (Indisponível) |
|   H_2_1    |      0.000221 |                |
|   V_1_0    |      0.000206 | (Indisponível) |
|   V_3_4    |      0.000085 | (Indisponível) |
|   H_4_5    |      0.000081 | (Indisponível) |
|   H_0_3    |      0.000072 | (Indisponível) |
|   H_4_1    |      0.000063 | (Indisponível) |
|   H_8_5    |      0.000062 | (Indisponível) |
|   V_5_0    |      0.000048 | (Indisponível) |
|   V_5_2    |      0.000046 | (Indisponível) |
|   V_5_6    |      0.000041 | (Indisponível) |
|   V_1_4    |      0.000039 | (Indisponível) |
|   V_3_0    |      0.000037 | (Indisponível) |
|   H_6_5    |      0.000032 | (Indisponível) |
|   V_5_4    |      0.000030 | (Indisponível) |
|   V_7_6    |      0.000027 | (Indisponível) |
|   H_8_3    |      0.000023 | (Indisponível) |
|   H_4_3    |      0.000021 | (Indisponível) |
|   V_7_4    |      0.000020 | (Indisponível) |
|   H_6_3    |      0.000018 | (Indisponível) |
|   V_7_0    |      0.000013 | (Indisponível) |
...
- `cnn2_partida074_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida074_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida074_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida074_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
