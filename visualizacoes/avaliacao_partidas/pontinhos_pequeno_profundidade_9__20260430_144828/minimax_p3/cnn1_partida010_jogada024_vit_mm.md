...
|:----------:|:-------------:|:--------------:|
|   V_7_0    |      0.990705 | ⭐ (Escolhida)  |
|   H_6_1    |      0.006986 |                |
|   H_8_3    |      0.000831 |                |
|   H_8_1    |      0.000527 | (Indisponível) |
|   H_6_3    |      0.000185 |                |
|   V_5_0    |      0.000184 | (Indisponível) |
|   V_1_6    |      0.000069 |                |
|   V_5_2    |      0.000060 | (Indisponível) |
|   H_4_1    |      0.000042 | (Indisponível) |
|   H_4_3    |      0.000035 |                |
|   V_7_4    |      0.000035 | (Indisponível) |
|   H_0_5    |      0.000034 | (Indisponível) |
|   V_7_2    |      0.000028 | (Indisponível) |
|   V_1_4    |      0.000025 |                |
|   H_8_5    |      0.000025 | (Indisponível) |
|   V_7_6    |      0.000024 | (Indisponível) |
|   V_3_2    |      0.000020 | (Indisponível) |
|   H_2_3    |      0.000019 |                |
|   H_0_3    |      0.000019 | (Indisponível) |
|   V_5_4    |      0.000018 | (Indisponível) |
|   H_2_5    |      0.000015 | (Indisponível) |
|   V_5_6    |      0.000015 | (Indisponível) |
|   V_3_0    |      0.000015 | (Indisponível) |
|   H_6_5    |      0.000014 | (Indisponível) |
|   H_0_1    |      0.000013 | (Indisponível) |
|   V_3_6    |      0.000011 | (Indisponível) |
|   H_2_1    |      0.000010 | (Indisponível) |
...
- `cnn1_partida010_jogada024_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida010_jogada024_vit_mm.md` — este relatório
- `cnn1_partida010_jogada024_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida010_jogada024_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
