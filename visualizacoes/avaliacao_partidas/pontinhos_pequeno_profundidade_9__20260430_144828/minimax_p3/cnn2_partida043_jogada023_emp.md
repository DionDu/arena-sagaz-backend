# Caixa perdida — partida 43, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.997490 | ⭐ (Escolhida)  |
|   H_2_1    |      0.001331 |                |
|   H_0_1    |      0.000922 | (Indisponível) |
|   V_7_6    |      0.000049 |                |
|   V_7_4    |      0.000027 |                |
|   V_1_6    |      0.000024 |                |
...
- `cnn2_partida043_jogada023_emp.png` — visualização com numeração de arestas
- `cnn2_partida043_jogada023_emp.md` — este relatório
- `cnn2_partida043_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida043_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
