# Caixa perdida — partida 39, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_5_0    |      0.963762 | ⭐ (Escolhida)  |
|   H_4_1    |      0.034204 |                |
|   H_4_5    |      0.000275 |                |
|   V_3_2    |      0.000228 | (Indisponível) |
|   H_4_3    |      0.000218 |                |
|   V_3_0    |      0.000192 | (Indisponível) |
|   V_5_4    |      0.000183 |                |
|   V_3_4    |      0.000138 |                |
|   V_5_2    |      0.000105 | (Indisponível) |
|   H_8_5    |      0.000072 | (Indisponível) |
|   V_7_6    |      0.000055 | (Indisponível) |
|   V_3_6    |      0.000054 | (Indisponível) |
|   H_6_5    |      0.000051 | (Indisponível) |
|   V_5_6    |      0.000044 | (Indisponível) |
|   H_0_1    |      0.000040 | (Indisponível) |
|   H_6_1    |      0.000035 | (Indisponível) |
|   V_7_4    |      0.000034 | (Indisponível) |
|   V_1_0    |      0.000033 | (Indisponível) |
|   H_8_1    |      0.000032 | (Indisponível) |
|   H_2_1    |      0.000029 | (Indisponível) |
|   V_7_0    |      0.000029 | (Indisponível) |
|   H_6_3    |      0.000028 | (Indisponível) |
|   V_7_2    |      0.000028 | (Indisponível) |
|   H_2_5    |      0.000026 | (Indisponível) |
|   H_0_5    |      0.000026 | (Indisponível) |
|   H_8_3    |      0.000024 | (Indisponível) |
|   H_2_3    |      0.000015 | (Indisponível) |
|   V_1_6    |      0.000014 | (Indisponível) |
...
- `cnn2_partida039_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida039_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida039_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida039_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
