# Caixa perdida — partida 66, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   H_8_3    |      0.983903 | ⭐ (Escolhida)  |
|   H_6_3    |      0.013491 |                |
|   V_1_0    |      0.000507 |                |
|   V_1_6    |      0.000455 |                |
|   H_0_1    |      0.000177 | (Indisponível) |
|   V_1_4    |      0.000131 |                |
|   H_8_5    |      0.000117 | (Indisponível) |
|   H_2_3    |      0.000105 |                |
|   V_7_6    |      0.000103 | (Indisponível) |
|   H_0_5    |      0.000095 | (Indisponível) |
|   V_5_2    |      0.000094 | (Indisponível) |
|   H_0_3    |      0.000077 | (Indisponível) |
|   V_5_6    |      0.000073 | (Indisponível) |
|   H_2_1    |      0.000068 |                |
|   H_4_1    |      0.000063 | (Indisponível) |
|   V_1_2    |      0.000061 | (Indisponível) |
|   H_6_5    |      0.000056 | (Indisponível) |
|   V_5_4    |      0.000053 | (Indisponível) |
|   V_5_0    |      0.000052 | (Indisponível) |
|   V_7_4    |      0.000048 | (Indisponível) |
|   V_3_2    |      0.000040 |                |
|   V_3_6    |      0.000038 | (Indisponível) |
|   V_3_0    |      0.000037 | (Indisponível) |
|   V_7_0    |      0.000030 | (Indisponível) |
|   H_2_5    |      0.000029 | (Indisponível) |
|   H_4_3    |      0.000029 | (Indisponível) |
...
- `cnn1_partida066_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida066_jogada024_vit_cnn.md` — este relatório
- `cnn1_partida066_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida066_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
