# Caixa perdida — partida 38, jogada 23
...
|   V_7_4    |      0.000011 | (Indisponível) |
|   H_8_1    |      0.000010 | (Indisponível) |
|   H_6_5    |      0.000009 | (Indisponível) |
...
- `cnn1_partida038_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida038_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida038_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida038_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
