# Caixa perdida — partida 0, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.984767 | ⭐ (Escolhida)  |
|   H_6_5    |      0.013065 |                |
|   H_8_5    |      0.000699 | (Indisponível) |
|   V_1_6    |      0.000231 |                |
|   V_5_6    |      0.000143 | (Indisponível) |
|   V_7_0    |      0.000135 |                |
|   V_7_2    |      0.000133 |                |
|   H_6_3    |      0.000121 |                |
...
|   V_5_2    |      0.000017 | (Indisponível) |
|   V_5_0    |      0.000015 | (Indisponível) |
|   V_3_2    |      0.000014 | (Indisponível) |
...
- `cnn1_partida000_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida000_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida000_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida000_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
