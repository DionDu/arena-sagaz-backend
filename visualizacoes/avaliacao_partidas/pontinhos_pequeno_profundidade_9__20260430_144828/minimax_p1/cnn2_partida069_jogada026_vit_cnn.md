# Caixa perdida — partida 69, jogada 26
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.959257 | ⭐ (Escolhida)  |
|   H_4_1    |      0.039090 |                |
|   H_4_5    |      0.000272 |                |
|   V_5_4    |      0.000178 |                |
|   H_4_3    |      0.000138 |                |
|   V_5_2    |      0.000095 | (Indisponível) |
|   V_3_2    |      0.000075 | (Indisponível) |
|   V_5_0    |      0.000074 | (Indisponível) |
|   V_3_4    |      0.000064 |                |
|   H_6_5    |      0.000062 | (Indisponível) |
|   V_7_6    |      0.000062 | (Indisponível) |
|   V_3_6    |      0.000062 | (Indisponível) |
|   V_5_6    |      0.000061 | (Indisponível) |
|   H_2_5    |      0.000055 | (Indisponível) |
|   H_8_3    |      0.000049 | (Indisponível) |
|   H_8_5    |      0.000043 | (Indisponível) |
|   V_1_0    |      0.000040 | (Indisponível) |
|   H_0_1    |      0.000036 | (Indisponível) |
|   H_0_5    |      0.000034 | (Indisponível) |
|   H_6_3    |      0.000034 | (Indisponível) |
|   V_7_4    |      0.000031 | (Indisponível) |
|   H_6_1    |      0.000025 | (Indisponível) |
|   V_1_6    |      0.000024 | (Indisponível) |
|   H_8_1    |      0.000022 | (Indisponível) |
|   H_2_3    |      0.000022 | (Indisponível) |
|   V_1_2    |      0.000021 | (Indisponível) |
|   V_7_2    |      0.000017 | (Indisponível) |
|   V_7_0    |      0.000016 | (Indisponível) |
|   H_0_3    |      0.000015 | (Indisponível) |
|   H_2_1    |      0.000014 | (Indisponível) |
|   V_1_4    |      0.000011 | (Indisponível) |
...
- `cnn2_partida069_jogada026_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida069_jogada026_vit_cnn.md` — este relatório
- `cnn2_partida069_jogada026_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida069_jogada026_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
