# Caixa perdida — partida 46, jogada 30
...
## Placar
- **No momento da decisão:** CNN **10** × **0** Minimax
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.961508 | ⭐ (Escolhida)  |
|   H_6_5    |      0.036559 |                |
|   H_8_5    |      0.001304 | (Indisponível) |
|   V_5_6    |      0.000200 | (Indisponível) |
|   H_4_5    |      0.000087 | (Indisponível) |
|   V_5_4    |      0.000054 | (Indisponível) |
|   V_3_6    |      0.000046 | (Indisponível) |
|   H_8_3    |      0.000030 | (Indisponível) |
|   V_7_4    |      0.000029 | (Indisponível) |
|   H_4_1    |      0.000023 | (Indisponível) |
|   H_2_5    |      0.000019 | (Indisponível) |
|   H_6_3    |      0.000016 | (Indisponível) |
|   H_8_1    |      0.000015 | (Indisponível) |
|   V_7_2    |      0.000014 | (Indisponível) |
|   H_0_5    |      0.000013 | (Indisponível) |
|   V_1_6    |      0.000012 | (Indisponível) |
|   H_0_1    |      0.000011 | (Indisponível) |
|   V_7_0    |      0.000010 | (Indisponível) |
|   V_5_0    |      0.000009 | (Indisponível) |
|   V_1_0    |      0.000007 | (Indisponível) |
|   V_5_2    |      0.000006 | (Indisponível) |
|   H_0_3    |      0.000005 | (Indisponível) |
...
- `cnn2_partida046_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida046_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida046_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida046_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
