...
|:----------:|:-------------:|:--------------:|
|   H_8_3    |      0.978180 | ⭐ (Escolhida)  |
|   V_7_2    |      0.021254 |                |
|   V_7_0    |      0.000206 | (Indisponível) |
|   H_8_1    |      0.000118 | (Indisponível) |
|   H_8_5    |      0.000061 | (Indisponível) |
|   V_7_6    |      0.000039 | (Indisponível) |
|   H_6_1    |      0.000020 | (Indisponível) |
|   V_7_4    |      0.000013 | (Indisponível) |
|   V_5_0    |      0.000012 | (Indisponível) |
|   V_5_6    |      0.000011 | (Indisponível) |
|   H_6_5    |      0.000011 | (Indisponível) |
|   H_4_1    |      0.000011 | (Indisponível) |
...
- `cnn2_partida093_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida093_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida093_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida093_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
