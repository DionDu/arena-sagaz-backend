...
|:----------:|:-------------:|:--------------:|
|   H_0_1    |      0.977491 | ⭐ (Escolhida)  |
|   H_2_1    |      0.022033 |                |
|   V_1_0    |      0.000347 | (Indisponível) |
...
- `cnn2_partida036_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida036_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida036_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida036_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
