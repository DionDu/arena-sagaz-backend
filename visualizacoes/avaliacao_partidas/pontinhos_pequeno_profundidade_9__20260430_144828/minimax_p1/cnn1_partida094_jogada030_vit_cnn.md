...
|:----------:|:-------------:|:--------------:|
|   V_3_6    |      0.969777 | ⭐ (Escolhida)  |
|   H_4_5    |      0.029936 |                |
|   V_5_6    |      0.000142 | (Indisponível) |
...
- `cnn1_partida094_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida094_jogada030_vit_cnn.md` — este relatório
- `cnn1_partida094_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida094_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
