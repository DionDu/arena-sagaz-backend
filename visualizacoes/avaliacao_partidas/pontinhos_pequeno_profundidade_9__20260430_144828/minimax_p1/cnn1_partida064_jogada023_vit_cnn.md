# Caixa perdida — partida 64, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_7_6    |      0.990206 | ⭐ (Escolhida)  |
|   H_6_5    |      0.007858 |                |
|   H_8_5    |      0.000859 | (Indisponível) |
|   H_0_5    |      0.000201 |                |
|   H_8_1    |      0.000138 |                |
|   H_4_1    |      0.000087 |                |
|   V_5_6    |      0.000081 | (Indisponível) |
|   V_1_2    |      0.000070 |                |
|   V_1_4    |      0.000043 |                |
|   H_0_1    |      0.000039 | (Indisponível) |
|   V_5_4    |      0.000036 | (Indisponível) |
|   H_2_1    |      0.000034 |                |
|   V_1_0    |      0.000030 | (Indisponível) |
|   V_5_0    |      0.000027 | (Indisponível) |
|   H_8_3    |      0.000026 | (Indisponível) |
|   V_7_0    |      0.000025 | (Indisponível) |
|   H_6_1    |      0.000025 |                |
|   V_1_6    |      0.000024 | (Indisponível) |
|   V_3_6    |      0.000024 | (Indisponível) |
|   H_2_5    |      0.000023 | (Indisponível) |
|   H_4_5    |      0.000023 | (Indisponível) |
|   H_0_3    |      0.000022 | (Indisponível) |
|   V_7_2    |      0.000018 | (Indisponível) |
|   V_3_0    |      0.000016 | (Indisponível) |
|   V_5_2    |      0.000016 | (Indisponível) |
|   V_7_4    |      0.000015 | (Indisponível) |
|   H_6_3    |      0.000014 | (Indisponível) |
|   V_3_2    |      0.000006 | (Indisponível) |
|   H_4_3    |      0.000005 | (Indisponível) |
|   H_2_3    |      0.000004 | (Indisponível) |
|   V_3_4    |      0.000003 | (Indisponível) |
...
- `cnn1_partida064_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida064_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida064_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida064_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
