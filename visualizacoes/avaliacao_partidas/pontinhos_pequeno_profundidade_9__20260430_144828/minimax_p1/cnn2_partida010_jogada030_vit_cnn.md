...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.954044 | ⭐ (Escolhida)  |
|   V_7_2    |      0.045018 |                |
|   V_7_0    |      0.000198 | (Indisponível) |
|   H_8_3    |      0.000194 | (Indisponível) |
|   V_7_4    |      0.000130 | (Indisponível) |
...
- `cnn2_partida010_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida010_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida010_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida010_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
