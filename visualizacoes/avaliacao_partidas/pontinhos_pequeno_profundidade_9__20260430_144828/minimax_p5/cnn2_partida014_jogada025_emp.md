# Caixa perdida — partida 14, jogada 25
...
- `cnn2_partida014_jogada025_emp.png` — visualização com numeração de arestas
- `cnn2_partida014_jogada025_emp.md` — este relatório
- `cnn2_partida014_jogada025_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida014_jogada025_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
