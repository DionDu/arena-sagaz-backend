# Caixa perdida — partida 58, jogada 20
...
|:----------:|:-------------:|:--------------:|
|   H_0_5    |      0.996715 | ⭐ (Escolhida)  |
|   V_1_6    |      0.001506 | (Indisponível) |
|   V_1_4    |      0.001452 |                |
|   H_8_5    |      0.000050 |                |
...
- `cnn1_partida058_jogada020_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida058_jogada020_vit_cnn.md` — este relatório
- `cnn1_partida058_jogada020_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida058_jogada020_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
