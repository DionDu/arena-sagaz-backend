# Caixa perdida — partida 90, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.990178 | ⭐ (Escolhida)  |
|   H_4_1    |      0.009277 |                |
|   V_5_0    |      0.000053 | (Indisponível) |
|   H_8_5    |      0.000036 |                |
|   H_2_5    |      0.000035 |                |
...
- `cnn1_partida090_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida090_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida090_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida090_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
