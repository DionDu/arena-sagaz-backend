# Caixa perdida — partida 50, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.985882 | ⭐ (Escolhida)  |
|   H_6_1    |      0.011990 |                |
|   V_7_0    |      0.000610 | (Indisponível) |
|   V_5_0    |      0.000220 | (Indisponível) |
|   H_6_3    |      0.000198 |                |
|   V_7_4    |      0.000197 |                |
|   V_7_6    |      0.000173 |                |
|   V_3_6    |      0.000116 |                |
|   V_5_2    |      0.000093 | (Indisponível) |
|   H_4_3    |      0.000086 |                |
|   H_4_1    |      0.000054 | (Indisponível) |
|   V_3_4    |      0.000047 |                |
|   H_8_3    |      0.000045 | (Indisponível) |
...
- `cnn2_partida050_jogada024_vit_mm.png` — visualização com numeração de arestas
- `cnn2_partida050_jogada024_vit_mm.md` — este relatório
- `cnn2_partida050_jogada024_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida050_jogada024_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
