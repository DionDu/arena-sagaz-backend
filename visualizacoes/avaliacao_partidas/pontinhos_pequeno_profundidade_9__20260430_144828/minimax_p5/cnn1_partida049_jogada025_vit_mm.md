# Caixa perdida — partida 49, jogada 25
...
|:----------:|:-------------:|:--------------:|
|   H_8_1    |      0.972328 | ⭐ (Escolhida)  |
|   H_6_1    |      0.024326 |                |
|   H_8_3    |      0.000903 |                |
|   V_7_0    |      0.000542 | (Indisponível) |
|   H_6_3    |      0.000305 |                |
|   V_5_0    |      0.000279 | (Indisponível) |
|   H_0_3    |      0.000230 |                |
|   V_5_2    |      0.000156 | (Indisponível) |
|   H_4_3    |      0.000117 |                |
|   H_4_1    |      0.000104 | (Indisponível) |
|   H_2_3    |      0.000087 |                |
|   V_7_4    |      0.000075 | (Indisponível) |
|   V_3_0    |      0.000059 | (Indisponível) |
|   V_3_2    |      0.000059 | (Indisponível) |
|   V_7_6    |      0.000051 | (Indisponível) |
|   V_5_6    |      0.000047 | (Indisponível) |
|   V_5_4    |      0.000041 | (Indisponível) |
|   H_8_5    |      0.000040 | (Indisponível) |
|   V_7_2    |      0.000037 | (Indisponível) |
|   V_3_4    |      0.000028 | (Indisponível) |
|   V_3_6    |      0.000028 | (Indisponível) |
|   H_6_5    |      0.000025 | (Indisponível) |
|   H_2_1    |      0.000020 | (Indisponível) |
|   H_4_5    |      0.000020 | (Indisponível) |
|   H_0_1    |      0.000019 | (Indisponível) |
|   H_0_5    |      0.000017 | (Indisponível) |
|   V_1_2    |      0.000016 | (Indisponível) |
|   V_1_0    |      0.000015 | (Indisponível) |
|   V_1_6    |      0.000010 | (Indisponível) |
|   H_2_5    |      0.000009 | (Indisponível) |
|   V_1_4    |      0.000007 | (Indisponível) |
...
- `cnn1_partida049_jogada025_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida049_jogada025_vit_mm.md` — este relatório
- `cnn1_partida049_jogada025_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida049_jogada025_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
