# Caixa perdida — partida 93, jogada 22
...
|:----------:|:-------------:|:--------------:|
|   V_3_0    |      0.996023 | ⭐ (Escolhida)  |
|   H_4_1    |      0.003627 |                |
|   V_5_0    |      0.000047 | (Indisponível) |
|   V_1_6    |      0.000037 |                |
|   H_8_3    |      0.000033 |                |
|   H_2_5    |      0.000021 |                |
|   H_0_5    |      0.000019 | (Indisponível) |
|   V_7_6    |      0.000018 | (Indisponível) |
...
- `cnn1_partida093_jogada022_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida093_jogada022_vit_cnn.md` — este relatório
- `cnn1_partida093_jogada022_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida093_jogada022_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
