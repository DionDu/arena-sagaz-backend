# Caixa perdida — partida 24, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.997429 | ⭐ (Escolhida)  |
|   H_2_1    |      0.001181 |                |
|   H_0_1    |      0.001083 | (Indisponível) |
|   H_0_3    |      0.000084 |                |
...
- `cnn1_partida024_jogada023_emp.png` — visualização com numeração de arestas
- `cnn1_partida024_jogada023_emp.md` — este relatório
- `cnn1_partida024_jogada023_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida024_jogada023_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
