...
- `cnn1_partida028_jogada030_emp.png` — visualização com numeração de arestas
- `cnn1_partida028_jogada030_emp.md` — este relatório
- `cnn1_partida028_jogada030_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida028_jogada030_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
