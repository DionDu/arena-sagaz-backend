# Caixa perdida — partida 75, jogada 30
...
- `cnn1_partida075_jogada030_vit_mm.png` — visualização com numeração de arestas
- `cnn1_partida075_jogada030_vit_mm.md` — este relatório
- `cnn1_partida075_jogada030_vit_mm_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida075_jogada030_vit_mm_crua.npy` — matriz crua (encoding partida bruto, NumPy)
