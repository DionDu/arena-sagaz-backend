# Caixa perdida — partida 94, jogada 24
...
|:----------:|:-------------:|:--------------:|
|   H_8_5    |      0.998668 | ⭐ (Escolhida)  |
|   V_7_4    |      0.000937 |                |
|   V_7_6    |      0.000261 | (Indisponível) |
|   V_5_4    |      0.000022 |                |
|   H_4_5    |      0.000019 |                |
|   H_6_3    |      0.000014 | (Indisponível) |
|   H_8_3    |      0.000013 | (Indisponível) |
|   H_2_5    |      0.000010 |                |
...
- `cnn2_partida094_jogada024_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida094_jogada024_vit_cnn.md` — este relatório
- `cnn2_partida094_jogada024_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida094_jogada024_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
