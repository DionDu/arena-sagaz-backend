...
|:----------:|:-------------:|:--------------:|
|   V_1_0    |      0.994898 | ⭐ (Escolhida)  |
|   H_2_1    |      0.003212 |                |
|   H_0_1    |      0.001441 | (Indisponível) |
|   V_7_6    |      0.000060 |                |
|   V_1_6    |      0.000037 |                |
|   V_3_2    |      0.000032 | (Indisponível) |
...
- `cnn1_partida092_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida092_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida092_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida092_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
