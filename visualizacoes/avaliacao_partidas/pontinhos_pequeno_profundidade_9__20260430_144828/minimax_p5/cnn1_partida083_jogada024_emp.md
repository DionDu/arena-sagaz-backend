...
## Placar
- **No momento da decisão:** CNN **3** × **2** Minimax
...
|:----------:|:-------------:|:--------------:|
|   V_5_6    |      0.966599 | ⭐ (Escolhida)  |
|   V_5_4    |      0.032036 |                |
|   V_3_6    |      0.000528 |                |
|   V_7_6    |      0.000096 | (Indisponível) |
|   H_8_5    |      0.000092 | (Indisponível) |
|   H_4_5    |      0.000079 | (Indisponível) |
|   H_0_1    |      0.000051 | (Indisponível) |
|   H_0_3    |      0.000042 |                |
|   V_1_0    |      0.000039 | (Indisponível) |
|   V_7_4    |      0.000038 | (Indisponível) |
|   V_5_0    |      0.000038 | (Indisponível) |
...
- `cnn1_partida083_jogada024_emp.png` — visualização com numeração de arestas
- `cnn1_partida083_jogada024_emp.md` — este relatório
- `cnn1_partida083_jogada024_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida083_jogada024_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
