# Caixa perdida — partida 22, jogada 30
...
|:----------:|:-------------:|:--------------:|
|   H_8_3    |      0.930093 | ⭐ (Escolhida)  |
|   H_6_3    |      0.068967 |                |
|   H_8_5    |      0.000147 | (Indisponível) |
|   V_7_6    |      0.000099 | (Indisponível) |
|   V_5_2    |      0.000091 | (Indisponível) |
|   V_5_4    |      0.000060 | (Indisponível) |
|   H_6_5    |      0.000055 | (Indisponível) |
|   H_0_1    |      0.000046 | (Indisponível) |
|   V_7_4    |      0.000042 | (Indisponível) |
|   V_3_6    |      0.000036 | (Indisponível) |
|   H_4_1    |      0.000036 | (Indisponível) |
|   V_5_6    |      0.000032 | (Indisponível) |
|   V_1_0    |      0.000031 | (Indisponível) |
|   H_4_3    |      0.000028 | (Indisponível) |
|   V_1_6    |      0.000024 | (Indisponível) |
|   H_0_5    |      0.000021 | (Indisponível) |
|   H_0_3    |      0.000019 | (Indisponível) |
|   H_2_3    |      0.000019 | (Indisponível) |
|   H_4_5    |      0.000018 | (Indisponível) |
|   V_5_0    |      0.000016 | (Indisponível) |
|   V_7_0    |      0.000016 | (Indisponível) |
|   H_2_5    |      0.000016 | (Indisponível) |
|   V_3_0    |      0.000014 | (Indisponível) |
...
|   H_8_1    |      0.000007 | (Indisponível) |
|   H_6_1    |      0.000005 | (Indisponível) |
...
- `cnn2_partida022_jogada030_vit_cnn.png` — visualização com numeração de arestas
- `cnn2_partida022_jogada030_vit_cnn.md` — este relatório
- `cnn2_partida022_jogada030_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida022_jogada030_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
