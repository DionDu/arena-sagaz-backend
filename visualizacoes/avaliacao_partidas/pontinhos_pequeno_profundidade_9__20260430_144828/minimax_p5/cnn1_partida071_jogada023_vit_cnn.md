# Caixa perdida — partida 71, jogada 23
...
|:----------:|:-------------:|:--------------:|
|   H_8_3    |      0.994918 | ⭐ (Escolhida)  |
|   V_7_2    |      0.004561 |                |
|   H_8_5    |      0.000224 |                |
|   V_7_0    |      0.000059 | (Indisponível) |
|   V_1_6    |      0.000037 |                |
|   H_6_5    |      0.000031 |                |
...
- `cnn1_partida071_jogada023_vit_cnn.png` — visualização com numeração de arestas
- `cnn1_partida071_jogada023_vit_cnn.md` — este relatório
- `cnn1_partida071_jogada023_vit_cnn_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn1_partida071_jogada023_vit_cnn_crua.npy` — matriz crua (encoding partida bruto, NumPy)
