...
- `cnn2_partida035_jogada030_emp.png` — visualização com numeração de arestas
- `cnn2_partida035_jogada030_emp.md` — este relatório
- `cnn2_partida035_jogada030_emp_norm.npy` — matriz normalizada (input da CNN, NumPy)
- `cnn2_partida035_jogada030_emp_crua.npy` — matriz crua (encoding partida bruto, NumPy)
